...
import Sidebar.Object.Animation.SidebarObjectAnimation;
...
class SidebarObject {
    ...
    private var objectType:UIText;
    private var objectUUID:UIInput;
    private var objectName:UIInput;
    private var objectPositionX:UINumber;
    private var objectPositionY:UINumber;
    private var objectPositionZ:UINumber;
    private var objectRotationX:UINumber;
    private var objectRotationY:UINumber;
    private var objectRotationZ:UINumber;
    private var objectScaleX:UINumber;
    private var objectScaleY:UINumber;
    private var objectScaleZ:UINumber;
    private var objectFov:UINumber;
    private var objectLeft:UINumber;
    private var objectRight:UINumber;
    private var objectTop:UINumber;
    private var objectBottom:UINumber;
    private var objectNear:UINumber;
    private var objectFar:UINumber;
    private var objectIntensity:UINumber;
    private var objectColor:UIColor;
    private var objectGroundColor:UIColor;
    private var objectDistance:UINumber;
    private var objectAngle:UINumber;
    private var objectPenumbra:UINumber;
    private var objectDecay:UINumber;
    private var objectCastShadow:UIBoolean;
    private var objectReceiveShadow:UIBoolean;
    private var objectShadowBias:UINumber;
    private var objectShadowNormalBias:UINumber;
    private var objectShadowRadius:UINumber;
    private var objectVisible:UICheckbox;
    private var objectFrustumCulled:UICheckbox;
    private var objectRenderOrder:UIInteger;
    private var objectUserData:UITextArea;
    ...
    public function new(editor:Dynamic) {
        ...
        objectUUID = new UIInput().setWidth('102px').setFontSize('12px').setDisabled(true);
        const objectUUIDRenew = new UIButton(strings.getKey('sidebar/object/new')).setMarginLeft('7px').onClick(function(_) {
        ...
        objectName = new UIInput().setWidth('150px').setFontSize('12px').onChange(function(_) {
        ...
        objectPositionX = new UINumber().setPrecision(3).setWidth('50px').onChange(update);
        objectPositionY = new UINumber().setPrecision(3).setWidth('50px').onChange(update);
        objectPositionZ = new UINumber().setPrecision(3).setWidth('50px').onChange(update);
        ...
        objectRotationX = new UINumber().setStep(10).setNudge(0.1).setUnit('°').setWidth('50px').onChange(update);
        objectRotationY = new UINumber().setStep(10).setNudge(0.1).setUnit('°').setWidth('50px').onChange(update);
        objectRotationZ = new UINumber().setStep(10).setNudge(0.1).setUnit('°').setWidth('50px').onChange(update);
        ...
        objectScaleX = new UINumber(1).setPrecision(3).setWidth('50px').onChange(update);
        objectScaleY = new UINumber(1).setPrecision(3).setWidth('50px').onChange(update);
        objectScaleZ = new UINumber(1).setPrecision(3).setWidth('50px').onChange(update);
        ...
        objectFov = new UINumber().onChange(update);
        ...
        objectLeft = new UINumber().onChange(update);
        ...
        objectRight = new UINumber().onChange(update);
        ...
        objectTop = new UINumber().onChange(update);
        ...
        objectBottom = new UINumber().onChange(update);
        ...
        objectNear = new UINumber().onChange(update);
        ...
        objectFar = new UINumber().onChange(update);
        ...
        objectIntensity = new UINumber().onChange(update);
        ...
        objectColor = new UIColor().onInput(update);
        ...
        objectGroundColor = new UIColor().onInput(update);
        ...
        objectDistance = new UINumber().setRange(0, Float.POSITIVE_INFINITY).onChange(update);
        ...
        objectAngle = new UINumber().setPrecision(3).setRange(0, Math.PI / 2).onChange(update);
        ...
        objectPenumbra = new UINumber().setRange(0, 1).onChange(update);
        ...
        objectDecay = new UINumber().setRange(0, Float.POSITIVE_INFINITY).onChange(update);
        ...
        objectCastShadow = new UIBoolean(false, strings.getKey('sidebar/object/cast')).onChange(update);
        objectShadowRow.add(objectCastShadow);

        objectReceiveShadow = new UIBoolean(false, strings.getKey('sidebar/object/receive')).onChange(update);
        ...
        objectShadowBias = new UINumber(0).setPrecision(5).setStep(0.0001).setNudge(0.00001).onChange(update);
        ...
        objectShadowNormalBias = new UINumber(0).onChange(update);
        ...
        objectShadowRadius = new UINumber(1).onChange(update);
        ...
        objectVisible = new UICheckbox().onChange(update);
        ...
        objectFrustumCulled = new UICheckbox().onChange(update);
        ...
        objectRenderOrder = new UIInteger().setWidth('50px').onChange(update);
        ...
        objectUserData = new UITextArea().setWidth('150px').setHeight('40px').setFontSize('12px').onChange(update);
        objectUserData.onKeyUp(function(_) {
            try {
    ...
    private function updateRows(object) {
        const properties = {
            'fov': objectFovRow,
            'left': objectLeftRow,
        ...
        for (property in properties) {
            ...
            if (Std.is(uiElement, Array<Dynamic>)) {
    ...
    private function updateTransformRows(object) {
        if (object.isLight ||
    ...
    private function updateUI(object) {
