...
class GeometryParametersPanel {
  ...
  public function new(editor:Editor, object:THREE.Object3D) {
    ...
    var geometry:THREE.ExtrudeGeometry = cast object.geometry; // Assuming geometry is always ExtrudeGeometry
  ...
  function update() {
    ...
    editor.execute(new SetGeometryCommand(
      editor,
      object,
      new ExtrudeGeometry(
        parameters.shapes,
  ...
  function toShape() {
    editor.execute(new SetGeometryCommand(editor, object, new ShapeGeometry(parameters.shapes, options.curveSegments)));
  }
}