class Strings {
	...
	public static function new(config:Dynamic):Strings {
		return new Strings(config.getKey('language'));
	}
	...
	public function getKey(key:String):String {
		return this.values.get(this.language).get(key).default('???');
	}

	private var language:String;

	private var values:Map<String, Map<String, String>> = new Map<String, Map<String, String>>([
