...
import js.html.svg.SVGPathElement;
import js.html.svg.SVGUseElement;
...
class Script {
    ...
    public function new(editor:Editor) {
        ...
        var buttonSVG:SVGElement = createButtonSVG();
        ...
        codemirror = new CodeMirror(container.dom, {
            value: '',
            lineNumbers: true,
            matchBrackets: true,
            indentWithTabs: true,
    ...
    private function createButtonSVG():SVGElement {
