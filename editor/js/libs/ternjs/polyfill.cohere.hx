...
(function() {
  if (!Object.create) {
    Object.create = function(base) {
      if (base == null) {
        throw $global.Error('Object.create called with null');
      }
  ...
  if (!AP.lastIndexOf) {
    AP.lastIndexOf = function(x, start) {
  ...
  if (!String.prototype.trim) {
    String.prototype.trim = function() {
      ...
      while (from < to && this.charAt(from).charCodeAt(0) <= 32) {
        ++from;
      }
      while (from < to && this.charAt(to - 1).charCodeAt(0) <= 32) {
        --to;
      }
  ...
  R("json-stringify") || (r = { "\\": "\\\\", '"': '\\"', "\u0008": "\\b", "\u000c": "\\f", "\n": "\\n", "\r": "\\r", "\t": "\\t" }, t = function(b, c) {
    ...
    if (typeof g == "object" && g) {
      ...
      if (h == "[object Date]" && !m.call(g, "toJSON")) {
        ...
        if (typeof g.toJSON == "function" && (h != "[object Number]" && h != "[object String]" && h != "[object Array]" || m.call(g, "toJSON"))) {
          g = g.toJSON(b);
        }
      }
      a && (g = a.call(c, b, g));
      ...
      a && (l.call(a) == "[object Number]" ? (a = a - a % 1 > 0 ? "000000".slice(a) : "000000".slice(0, 10 - a)) : l.call(a) == "[object String]" && (a = a.length <= 10 ? a : a.slice(0, 10)));
      return x("", (h = {}, h[""] = b, h), j, f, a, "", []);
    });
  }

  R("json-parse") || (z = String.fromCharCode, B = { "\\": "\\", '"': '"', "/": "/", b: "\u0008", t: "\t", n: "\n", f: "\u000c", r: "\r" }, C = function() {
    H = I = k;
    throw $global.SyntaxError();
  }, D = function() {
    for (var b = I, c = b.length, a, d, j, f, o; H < c; ) {
      ...
      a = F(b, c, a);
      a === e ? Reflect.deleteField(b, c) : Reflect.setField(b, c, a);
    }, F = function(b, c, a) {
      var d = b[c], j;
      if (typeof d == "object" && d) {
        l.call(d) == "[object Array]" ? (j = d.length, a = function(b, c) {
          G(d, b, c);
        }) : n(d, function(b) {
          G(d, b, a);
        });
