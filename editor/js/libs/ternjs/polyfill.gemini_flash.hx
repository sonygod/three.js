...
class TernShim {
  static function main() {
    if (js.Boot.getClass(Object).get() == null) {
      ...
      Object.create = function(base) {
        var ctor = function() {};
        var frame = js.html.Document.get().body.appendChild(js.html.Document.get().createElement("iframe"));
    ...
    Array.isArray = Array.isArray || function(v) {
      return js.Boot.getClass(v).get().toString() == "[object Array]";
    };
    ...
    if (js.Boot.getClass(window).get().JSON == null) {
      (function() {
        var e = void 0, i = true, k = null, l = {}.toString, m, n, p = "function" == typeof define && define.c, q = !p && "object" == typeof exports && exports;
        ...
        if (!R("json")) {
          ...
          R("json-stringify") || (r = {"\\": "\\\\", '"': '\\"', "\u0008": "\\b", "\u000c": "\\f", "\n": "\\n", "\r": "\\r", "\t": "\\t"}, t = function(b, c) {
            ...
            if (typeof c == "function" ||
              typeof c == "object" && c) if (l.call(c) == "[object Function]") j = c;
          ...
          R("json-parse") || (z = String.fromCharCode, B = {"\\": "\\", '"': '"', "/": "/", b: "\u0008", t: "\t",
            ...
            var d = b[c], j;
            if (typeof d == "object" && d) if (l.call(d) == "[object Array]") for (j = d.length; j--;) G(d, j, a);
            else n(d, function(b) {
              G(d, b, a);
            });
            return a.call(b, c, d);
