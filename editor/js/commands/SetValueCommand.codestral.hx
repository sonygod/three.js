...
class SetValueCommand extends Command {
    ...
    public function new(editor:Editor, ?object:Dynamic = null, ?attributeName:String = '', ?newValue:Dynamic = null) {
        super(editor);
...
// Assuming Editor is a defined class in your Haxe project
class Editor {
