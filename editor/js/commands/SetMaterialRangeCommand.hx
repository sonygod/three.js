...
class SetMaterialRangeCommand extends Command {
    ...
    public function new(editor:Editor, object:threed.Object3D = null, attributeName:String = '', newMinValue:Float = -Math.POSITIVE_INFINITY, newMaxValue:Float = Math.POSITIVE_INFINITY, materialSlot:Int = -1) {
        super(editor);
        this.type = 'SetMaterialRangeCommand';
        this.name = editor.getStrings().getKey('command/SetMaterialRange') + ': ' + attributeName;
        this.updatable = true;
