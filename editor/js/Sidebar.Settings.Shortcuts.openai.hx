...
class SidebarSettingsShortcuts {
  public function new(editor:Editor) {
    ...
    var isMac = Sys.systemName().toUpperCase().indexOf("MAC") >= 0;
    ...
    function createShortcutInput(name:String) {
      ...
      shortcutInput.dom.addEventListener("keyup", function(event:Dynamic) {
    ...
    js.Browser.document.addEventListener("keydown", function(event:Dynamic) {
