...
class WebGLMaterials {
    ...
    static var _e1:Euler = new Euler();
    static var _m1:Matrix4 = new Matrix4();

    public function new(renderer, properties) {}
    ...
    function refreshUniformsPhysical(uniforms, material, transmissionRenderTarget) {
        ...
        uniforms.iridescenceThicknessMinimum.value = material.iridescenceThicknessRange.x;
        uniforms.iridescenceThicknessMaximum.value = material.iridescenceThicknessRange.y;
        ...
        uniforms.sheenColor.value.copy(material.sheenColor).multiplyScalar(material.sheenIntensity);
        ...
        if (transmissionRenderTarget != null) {
