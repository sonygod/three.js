...
class WebGLMorphtargets {
    private var morphTextures:WeakMap<Geometry, { count:Int, texture:DataArrayTexture, size:Vector2 }>;
    private var morph:Vector4;

    public function new(gl:WebGLRenderingContext, capabilities:Dynamic, textures:Dynamic) {
        morphTextures = new WeakMap();
        morph = new Vector4();
    }

    public function update(object:Dynamic, geometry:Geometry, program:Dynamic) {
