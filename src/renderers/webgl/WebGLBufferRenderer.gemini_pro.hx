class WebGLBufferRenderer {
	...
	public function renderMultiDraw(starts:Array<Int>, counts:Array<Int>, drawCount:Int) {
		...
		if (extension == null) {
			...
			cast(extension, WebGLMultiDraw).multiDrawArraysWEBGL(mode, starts, 0, counts, 0, drawCount);
			var elementCount = 0;
			for (i in 0...drawCount) {
	...
	public function renderMultiDrawInstances(starts:Array<Int>, counts:Array<Int>, drawCount:Int, primcount:Array<Int>) {
		...
		if (extension == null) {
			...
			cast(extension, WebGLMultiDraw).multiDrawArraysInstancedWEBGL(mode, starts, 0, counts, 0, primcount, 0, drawCount);
			var elementCount = 0;
			for (i in 0...drawCount) {
				elementCount += counts[i];
			}
