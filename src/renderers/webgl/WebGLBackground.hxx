...
class WebGLBackground {
    ...
    var clearColor:Color = new Color(0x000000);
    var clearAlpha:Float = alpha === true ? 0 : 1;

    var planeMesh:Mesh;
    var boxMesh:Mesh;

    var currentBackground:Dynamic;
    var currentBackgroundVersion:Int = 0;
    ...
    public function new(renderer:Dynamic, cubemaps:Dynamic, cubeuvmaps:Dynamic, state:Dynamic, objects:Dynamic, alpha:Bool, premultipliedAlpha:Bool) {
        ...
        function addToRenderList(renderList:Array<Dynamic>, scene:Dynamic):Void {
