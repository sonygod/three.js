...
// Define constants
@:final class ShaderChunk {
    public static inline var PI:Float = 3.141592653589793;
    public static inline var PI2:Float = 6.283185307179586;
    public static inline var PI_HALF:Float = 1.5707963267948966;
    public static inline var RECIPROCAL_PI:Float = 0.3183098861837907;
    public static inline var RECIPROCAL_PI2:Float = 0.15915494309189535;
    ...
    public static function rand(uv:Vec2):Float {
        ...
        var dt:Float = uv.dot(new Vec2(a, b));
        var sn:Float = dt % PI;
    ...
    public static function equirectUv(dir:Vec3):Vec2 {
        var u:Float = Math.atan2(dir.z, dir.x) * RECIPROCAL_PI2 + 0.5;
        var v:Float = Math.asin(clamp(dir.y, -1.0, 1.0)) * RECIPROCAL_PI + 0.5;
        return new Vec2(u, v);
    }
