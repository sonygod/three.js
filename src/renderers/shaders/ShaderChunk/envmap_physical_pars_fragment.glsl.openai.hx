...
extern inline function getIBLIrradiance(normal:Vec3):Vec3 {
...
extern inline function getIBLRadiance(viewDir:Vec3, normal:Vec3, roughness:Float):Vec3 {
    #if (ENVMAP_TYPE_CUBE_UV)
...
#if (USE_ANISOTROPY)
extern inline function getIBLAnisotropyRadiance(viewDir:Vec3, normal:Vec3, roughness:Float, bitangent:Vec3, anisotropy:Float):Vec3 {
    #if (ENVMAP_TYPE_CUBE_UV)
