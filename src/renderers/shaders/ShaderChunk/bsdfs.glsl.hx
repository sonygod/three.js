...
class Bsdfs {
    static public function G_BlinnPhong_Implicit():Float {
        // geometry term is (n dot l)(n dot v) / 4(n dot l)(n dot v)
        return 0.25;
    }

    static public function D_BlinnPhong(shininess:Float, dotNH:Float):Float {
        return 1.0 / Math.PI * (shininess * 0.5 + 1.0) * Math.pow(dotNH, shininess);
    }

    static public function BRDF_BlinnPhong(lightDir:Vec3, viewDir:Vec3, normal:Vec3, specularColor:Vec3, shininess:Float):Vec3 {
