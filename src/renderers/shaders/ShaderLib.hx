...
class ShaderLib {
  ...
  public static var backgroundCube = {
    uniforms: {
      envMap: { value: null },
      flipEnvMap: { value: -1 },
  ...
  public static var distanceRGBA = {
    uniforms: UniformsUtils.mergeUniforms([
      UniformsLib.common,
      UniformsLib.displacementmap,
      {
