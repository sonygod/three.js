...
import three.js.src.renderers.shaders.ShaderChunk.gradientmap_pars_fragment;
...
import three.js.src.renderers.shaders.ShaderChunk.lights_toon_pars_fragment;
...
import three.js.src.renderers.shaders.ShaderChunk.lights_toon_fragment;
...
class meshtoon {
    public static var vertex:String = "#define TOON\n\n" +
    ...
    public static var fragment:String = "#define TOON\n\n" +
