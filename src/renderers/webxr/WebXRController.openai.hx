...
class WebXRController {
  ...
  private var _moveEvent:Dynamic = { type: 'move' };
        ...
        if (grip != null && inputSource.gripSpace != null) {
          ...
          if (gripPose != null) {
            ...
            if (gripPose.linearVelocity != null) {
              ...
              grip.linearVelocity.copyFrom(gripPose.linearVelocity);
            } else {
              grip.hasLinearVelocity = false;
            }
            if (gripPose.angularVelocity != null) {
              grip.hasAngularVelocity = true;
              grip.angularVelocity.copyFrom(gripPose.angularVelocity);
            } else {
      ...
      if (targetRay != null) {
        ...
        if (inputPose != null) {
          ...
          if (inputPose.linearVelocity != null) {
            ...
            targetRay.linearVelocity.copyFrom(inputPose.linearVelocity);
          } else {
            targetRay.hasLinearVelocity = false;
          }
          if (inputPose.angularVelocity != null) {
            targetRay.hasAngularVelocity = true;
            targetRay.angularVelocity.copyFrom(inputPose.angularVelocity);
          } else {
