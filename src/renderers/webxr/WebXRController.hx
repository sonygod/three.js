...
class WebXRController {
    ...
    public function connect(inputSource:Dynamic) {
    ...
    public function disconnect(inputSource:Dynamic) {
    ...
    public function update(inputSource:Dynamic, frame:Dynamic, referenceSpace:Dynamic) {
    ...
    private function _getHandJoint(hand:Group, inputJoint:Dynamic) {
