...
class AnimationAction {
	...
	public function new( mixer:Mixer, clip:AnimationClip, localRoot:Dynamic = null, blendMode:Int = clip.blendMode ) {
		this._mixer = mixer;
		this._clip = clip;
		...
		if (weight > 0) {
			...
			switch (this.blendMode) {
				case AdditiveAnimationBlendMode:
					for (var j in 0...interpolants.length) {
