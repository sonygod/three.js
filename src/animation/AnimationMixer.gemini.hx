...
class AnimationMixer extends EventDispatcher {
	...
	private var _actionsByClip:Map<String, { knownActions:Array<AnimationAction>, actionByRoot:Map<String, AnimationAction> }> = new Map();

	private var _bindings:Array<PropertyMixer> = [];
	private var _nActiveBindings:Int = 0;

	private var _bindingsByRootAndName:Map<String, Map<String, PropertyMixer>> = new Map();
	...
	private function _addInactiveAction(action:AnimationAction, clipUuid:String, rootUuid:String):Void {
		...
		if (actionsForClip == null) {
			actionsForClip = { knownActions: [action], actionByRoot: new Map() };
