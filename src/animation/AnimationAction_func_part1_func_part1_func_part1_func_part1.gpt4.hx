...
class AnimationAction {
    ...
    public function new(mixer:Dynamic, clip:Dynamic, ?localRoot:Dynamic = null, ?blendMode:Dynamic = null) {
        this._mixer = mixer;
        this._clip = clip;
        this._localRoot = localRoot;
        this.blendMode = blendMode == null ? clip.blendMode : blendMode;

        var tracks = clip.tracks;
        var nTracks = tracks.length;
        var interpolants = new Array<Dynamic>(nTracks);
