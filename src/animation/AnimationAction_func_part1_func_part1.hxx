import three.js.src.animation.AnimationAction_func_part1_func_part1.constants.*;
...
class AnimationAction {
    ...
    public var _cacheIndex:Dynamic;
    public var _byClipCacheIndex:Dynamic;
    public var _timeScaleInterpolant:Dynamic;
    public var _weightInterpolant:Dynamic;
...
typedef AnimationAction = three.js.src.animation.AnimationAction_func_part1_func_part1.AnimationAction;