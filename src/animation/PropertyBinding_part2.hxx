class PropertyBinding {
	...
	public function new(rootNode:Dynamic, path:String, parsedPath:Dynamic) {
		this.path = path;
		this.parsedPath = parsedPath ? parsedPath : PropertyBinding.parseTrackName(path);
	...
	function _getValue_direct(buffer:Array<Dynamic>, offset:Int) {
		buffer[offset] = this.targetObject[this.propertyName];
	}

	function _getValue_array(buffer:Array<Dynamic>, offset:Int) {
	...
	function _getValue_arrayElement(buffer:Array<Dynamic>, offset:Int) {
		buffer[offset] = this.resolvedProperty[this.propertyIndex];
	}

	function _getValue_toArray(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty.toArray(buffer, offset);
	}

	function _setValue_direct(buffer:Array<Dynamic>, offset:Int) {
		this.targetObject[this.propertyName] = buffer[offset];
	}

	function _setValue_direct_setNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		this.targetObject[this.propertyName] = buffer[offset];
		this.targetObject.needsUpdate = true;
	}

	function _setValue_direct_setMatrixWorldNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		this.targetObject[this.propertyName] = buffer[offset];
		this.targetObject.matrixWorldNeedsUpdate = true;
	}

	function _setValue_array(buffer:Array<Dynamic>, offset:Int) {
	...
	function _setValue_array_setNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		var dest = this.resolvedProperty;
		for (i in dest) {
			dest[i] = buffer[offset++];
		}
	...
	function _setValue_array_setMatrixWorldNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		var dest = this.resolvedProperty;
		for (i in dest) {
			dest[i] = buffer[offset++];
		}
	...
	function _setValue_arrayElement(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty[this.propertyIndex] = buffer[offset];
	}

	function _setValue_arrayElement_setNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty[this.propertyIndex] = buffer[offset];
		this.targetObject.needsUpdate = true;
	}

	function _setValue_arrayElement_setMatrixWorldNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty[this.propertyIndex] = buffer[offset];
		this.targetObject.matrixWorldNeedsUpdate = true;
	}

	function _setValue_fromArray(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty.fromArray(buffer, offset);
	}

	function _setValue_fromArray_setNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty.fromArray(buffer, offset);
		this.targetObject.needsUpdate = true;
	}

	function _setValue_fromArray_setMatrixWorldNeedsUpdate(buffer:Array<Dynamic>, offset:Int) {
		this.resolvedProperty.fromArray(buffer, offset);
		this.targetObject.matrixWorldNeedsUpdate = true;
	}

	function _getValue_unbound(targetArray:Array<Dynamic>, offset:Int) {
		this.bind();
		this.getValue(targetArray, offset);
	}

	function _setValue_unbound(sourceArray:Array<Dynamic>, offset:Int) {
		this.bind();
	...
	function bind() {
		...
		if (propertyIndex != undefined) {
			...
			this.resolvedProperty = nodeProperty;
		} else if (haxe.ds.StringMap.isArray(nodeProperty)) {
