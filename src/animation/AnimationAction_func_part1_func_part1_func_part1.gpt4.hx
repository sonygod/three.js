...
class AnimationAction {
    ...
    public function new(mixer:Dynamic, clip:Dynamic, ?localRoot:Dynamic = null, ?blendMode:Int = null) {
        this._mixer = mixer;
        this._clip = clip;
        ...
        var interpolants = new Array<Dynamic>();
    ...
    private function _update(time:Float, deltaTime:Float, timeDirection:Int, accuIndex:Int):Void {
        if (!this.enabled) {
