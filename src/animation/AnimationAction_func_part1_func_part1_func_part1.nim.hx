...
class AnimationAction {
	...
	public var _cacheIndex:Null<Dynamic>;
	public var _byClipCacheIndex:Null<Dynamic>;
	...
	public function new(mixer:Dynamic, clip:Dynamic, localRoot:Null<Dynamic> = null, blendMode:Dynamic = clip.blendMode) {
		this._mixer = mixer;
		this._clip = clip;
		...
		const interpolants = new Array<Dynamic>();
	...
	public function setLoop(mode:Dynamic, repetitions:Float):AnimationAction {
		this.loop = mode;
	...
	public function _update(time:Float, deltaTime:Float, timeDirection:Float, accuIndex:Float):Void {
		// called by the mixer
