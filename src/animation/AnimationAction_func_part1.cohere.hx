...
class AnimationAction {
	...
	public var loop:AnimationLoopStyle;
	...
	public function new(mixer:AnimationMixer, clip:AnimationClip, ?localRoot:Dynamic, ?blendMode:AnimationBlendMode) {
		_mixer = mixer;
		_clip = clip;
	...
	public function setLoop(mode:AnimationLoopStyle, repetitions:Int):AnimationAction {
		loop = mode;
