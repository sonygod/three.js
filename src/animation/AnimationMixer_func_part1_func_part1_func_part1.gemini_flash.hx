...
class AnimationMixer extends EventDispatcher {
	...
	public var _accuIndex:Int = 0;
	public var time:Float = 0;
	public var timeScale:Float = 1.0;

	private var _actions:Array<AnimationAction> = [];
	private var _nActiveActions:Int = 0;
	private var _actionsByClip:Map<String, { knownActions:Array<AnimationAction>; actionByRoot:Map<String, AnimationAction> }> = new Map<String, { knownActions:Array<AnimationAction>; actionByRoot:Map<String, AnimationAction> }>();

	private var _bindings:Array<PropertyMixer> = [];
	private var _nActiveBindings:Int = 0;
	private var _bindingsByRootAndName:Map<String, Map<String, PropertyMixer>> = new Map<String, Map<String, PropertyMixer>>();

	private var _controlInterpolants:Array<LinearInterpolant> = [];
	private var _nActiveControlInterpolants:Int = 0;

	private static var _controlInterpolantsResultBuffer:Float32Array = new Float32Array(1);
	...
	private function _lendControlInterpolant():LinearInterpolant {
		...
		if (interpolant == null) {
			interpolant = new LinearInterpolant(new Float32Array(2), new Float32Array(2), 1, AnimationMixer._controlInterpolantsResultBuffer);
	...
	public function clipAction(clip:Dynamic, optionalRoot:Dynamic = null, blendMode:Int = null):AnimationAction {
	...
	public var stats: { actions: { get_total:()->Int; get_inUse:()->Int }; bindings: { get_total:()->Int; get_inUse:()->Int }; controlInterpolants: { get_total:()->Int; get_inUse:()->Int } } = {
		actions: {
			get_total: function() {
