...
class AnimationClip {
  ...
  public static function findByName(objectOrClipArray:Dynamic, name:String):AnimationClip {
    var clipArray:Array<AnimationClip> = objectOrClipArray;
    if (!Std.is(objectOrClipArray, Array)) {
      var o = objectOrClipArray;
      clipArray = o.geometry != null && o.geometry.animations != null ? o.geometry.animations : o.animations;
    }
  ...
  public static function parseAnimation(animation:Dynamic, bones:Array<Dynamic>):AnimationClip {
    ...
    var addNonemptyTrack = function(trackType:Class<KeyframeTrack>, trackName:String, animationKeys:Array<Dynamic>, propertyName:String, destTracks:Array<KeyframeTrack>):Void {
    ...
    var tracks:Array<KeyframeTrack> = [];
    var clipName = animation.name != null ? animation.name : "default";
    var fps = animation.fps != null ? animation.fps : 30;
    var blendMode = animation.blendMode;
    // automatic length determination in AnimationClip.
    var duration = animation.length != null ? animation.length : -1;
