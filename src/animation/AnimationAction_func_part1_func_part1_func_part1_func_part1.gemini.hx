...
class AnimationAction {
	...
	private var _localRoot:Null<Object3D>;
	...
	public function new(mixer:AnimationMixer, clip:AnimationClip, localRoot:Null<Object3D> = null, blendMode:Int = clip.blendMode) {
		this._mixer = mixer;
		this._clip = clip;
	...
	public function getRoot():Object3D {
