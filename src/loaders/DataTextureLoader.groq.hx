...
class DataTextureLoader extends Loader {
    ...
    public function load(url:String, onLoad:DataTexture->Dynamic->Void, onProgress:Float->Void, onError:Error->Void):DataTexture {
...
// Note: You need to implement the parse method in the subclass of DataTextureLoader