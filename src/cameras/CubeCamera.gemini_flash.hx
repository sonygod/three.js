...
class CubeCamera extends Object3D {
	...
	public function update(renderer:Dynamic, scene:Dynamic) {
		...
		var cameraPX:PerspectiveCamera = this.children[0];
		var cameraNX:PerspectiveCamera = this.children[1];
		var cameraPY:PerspectiveCamera = this.children[2];
		var cameraNY:PerspectiveCamera = this.children[3];
		var cameraPZ:PerspectiveCamera = this.children[4];
		var cameraNZ:PerspectiveCamera = this.children[5];
