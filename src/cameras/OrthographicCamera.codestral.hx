import Camera; // if Camera is in a separate file
...
class OrthographicCamera extends Camera {
    ...
    public function updateProjectionMatrix() {
        ...
        // Assuming projectionMatrix and projectionMatrixInverse are defined and have makeOrthographic and copy methods
