...
class Camera extends Object3D {
    ...
    override public function copy(source:Object3D, recursive:Bool = true):Camera {
    ...
    override public function updateWorldMatrix(updateParents:Bool = true, updateChildren:Bool = true):Void {
