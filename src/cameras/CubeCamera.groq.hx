...
class CubeCamera extends Object3D {
    public var type(default, null):String = 'CubeCamera';
    public var renderTarget(default, null):Dynamic;
    public var coordinateSystem(default, null):Null<Int>;
    public var activeMipmapLevel(default, null):Int;
