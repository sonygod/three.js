import openfl.display3D.PerspectiveCamera;
...
class CubeCamera extends Object3D {
    ...
    public function updateCoordinateSystem():Void {
        ...
        var cameraPX = cameras.shift();
        var cameraNX = cameras.shift();
        var cameraPY = cameras.shift();
        var cameraNY = cameras.shift();
        var cameraPZ = cameras.shift();
        var cameraNZ = cameras.shift();
