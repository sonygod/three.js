...
class OrthographicCamera extends Camera {
    ...
    public function copy(source:OrthographicCamera, recursive:Bool = false):OrthographicCamera {
        ...
        this.view = if (source.view == null) null else { enabled: source.view.enabled, fullWidth: source.view.fullWidth, fullHeight: source.view.fullHeight, offsetX: source.view.offsetX, offsetY: source.view.offsetY, width: source.view.width, height: source.view.height };
        return this;
    }
