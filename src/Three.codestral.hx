...
if (js.Browser.globalThis.hasOwnProperty("__THREE_DEVTOOLS__")) {
    js.Browser.globalThis.__THREE_DEVTOOLS__.dispatchEvent(new Event("register", { detail: {
        revision: REVISION,
    }}));
}

if (js.Browser.globalThis.hasOwnProperty("window")) {
    if (js.Browser.globalThis.window.hasOwnProperty("__THREE__")) {
        js.Browser.console.log("WARNING: Multiple instances of Three.js being imported.");
    } else {
        js.Browser.globalThis.window.__THREE__ = REVISION;
    }
}