...
import three.Three.Legacy;

class Three {
	static function main() {
		if (js.Lib.exists("window")) {
			if (js.Lib.exists("window.__THREE__")) {
				js.Lib.alert("WARNING: Multiple instances of Three.js being imported.");
			}
			else {
				js.Lib.set("window.__THREE__", REVISION);
			}
		}
		if (js.Lib.exists("window.__THREE_DEVTOOLS__")) {
			js.Lib.callMethod("window.__THREE_DEVTOOLS__.dispatchEvent", new js.html.CustomEvent("register", {detail: {revision: REVISION}}));
		}
	}
}
