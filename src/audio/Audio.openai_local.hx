...
class Audio extends Object3D {
    ...
    public function setMediaElementSource(mediaElement:MediaElementAudioSourceNode):Audio {
        this.hasPlaybackControl = false;
    ...
    public function setMediaStreamSource(mediaStream:MediaStreamAudioSourceNode):Audio {
        this.hasPlaybackControl = false;
