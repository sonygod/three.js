...
class Audio extends Object3D {
	...
	public var _startedAt: Float;
	public var _progress: Float;
	public var _connected: Bool;
	...
	public function setMediaElementSource(mediaElement: ???): Audio {
		this.hasPlaybackControl = false;
	...
	public function setMediaStreamSource(mediaStream: ???): Audio {
		this.hasPlaybackControl = false;
	...
	public function setDetune(value: Int): Audio {
		this.detune = value;
		if (this.isPlaying === true && this.source.detune != null) {
			this.source.detune.setTargetAtTime(this.detune, this.context.currentTime, 0.01);
		}
		return this;
	}

	public function getDetune(): Int {
		return this.detune;
	}
