...
class AudioListener extends Object3D {
	...
	override public function updateMatrixWorld(force:Bool = false):Void {
		...
		this.matrixWorld.decompose(null, null, null); // Decompose into position, quaternion, and scale
		var _position = new Vector3(this.position.x, this.position.y, this.position.z);
		var _quaternion = new Quaternion(this.quaternion.x, this.quaternion.y, this.quaternion.z, this.quaternion.w);
		var _orientation = new Vector3(0, 0, -1).applyQuaternion(_quaternion);
