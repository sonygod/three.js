...
class Scene extends Object3D {
	...
	public var background:Null<Any> = null;
	public var environment:Null<Any> = null;
	public var fog:Null<Any> = null;
...
public var overrideMaterial:Null<Any> = null;

public function new() {
	super();
	if (untyped __THREE_DEVTOOLS__ != null) {
		untyped __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent('observe', { detail: this }));
	}
}
...
public function toJSON(meta:Any = null):Dynamic {
