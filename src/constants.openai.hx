...
class Constants {
    ...
    public static inline var NoColorSpace:ColorSpace = "";
    public static inline var SRGBColorSpace:ColorSpace = "srgb";
    public static inline var LinearSRGBColorSpace:ColorSpace = "srgb-linear";
    public static inline var DisplayP3ColorSpace:ColorSpace = "display-p3";
    public static inline var LinearDisplayP3ColorSpace:ColorSpace = "display-p3-linear";
    
    public static inline var LinearTransfer:Transfer = "linear";
    public static inline var SRGBTransfer:Transfer = "srgb";
    
    public static inline var Rec709Primaries:Primaries = "rec709";
    public static inline var P3Primaries:Primaries = "p3";
