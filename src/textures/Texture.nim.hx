...
class Texture extends EventDispatcher {
    ...
    public static var _textureId:Int = 0;
    ...
    public function get image():Null<Dynamic> {
        return this.source.data;
    }

    public function set image(value:Null<Dynamic> = null) {
