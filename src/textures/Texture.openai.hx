...
class Texture extends EventDispatcher {
    ...
    public var internalFormat:PixelFormat;
    ...
    public function new(image:Dynamic = null, mapping:UVMapping = UVMapping, wrapS:WrappingMode = ClampToEdgeWrapping, wrapT:WrappingMode = ClampToEdgeWrapping, magFilter:Filter = LinearFilter, minFilter:Filter = LinearMipmapLinearFilter, format:PixelFormat = RGBAFormat, type:PixelType = UnsignedByteType, anisotropy:Int = DEFAULT_ANISOTROPY, colorSpace:ColorSpace = NoColorSpace) {
        super();
        this.isTexture = true;
        this.id = _textureId++;
    ...
    private function set_image(value:Dynamic):Void {
