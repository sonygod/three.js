...
class MeshPhongMaterial extends Material {
    ...
    public var wireframeLinecap:Dynamic;
    public var wireframeLinejoin:Dynamic;

    public var flatShading:Bool;

    public var fog:Bool;

    public function new( parameters = null ) {
...
typedef MeshPhongMaterialType = MeshPhongMaterial;

export { MeshPhongMaterialType as MeshPhongMaterial };