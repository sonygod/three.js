...
class MeshPhysicalMaterial extends MeshStandardMaterial {
	...
	public function new(parameters:Dynamic) {
		...
		this.reflectivity = function get():Float {
	...
	public function set anisotropy(value:Float):Void {
	...
	public function set clearcoat(value:Float):Void {
	...
	public function set iridescence(value:Float):Void {
	...
	public function set dispersion(value:Float):Void {
	...
	public function set sheen(value:Float):Void {
	...
	public function set transmission(value:Float):Void {
