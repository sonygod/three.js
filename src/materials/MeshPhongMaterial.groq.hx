...
```
Note that I've kept the same naming conventions and organization as the original JavaScript code. I've also assumed that the Haxe target is OpenFL, which is a common target for Haxe. If you're targeting a different platform, you may need to make some adjustments.