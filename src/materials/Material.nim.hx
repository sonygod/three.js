...
import EventDispatcher from '../core/EventDispatcher.hx';
import FrontSide, NormalBlending, LessEqualDepth, AddEquation, OneMinusSrcAlphaFactor, SrcAlphaFactor, AlwaysStencilFunc, KeepStencilOp from '../constants.hx';
...
class Material extends EventDispatcher {
	...
	public function get alphaTest() {

		return this._alphaTest;

	}

	public function set alphaTest( value ) {
	...
	public var needsUpdate( get, set ) {
