...
class BufferAttribute {
	...
	public var _updateRange:haxe.ds.GenericMap<String, Int>;
	...
	public function new(array:Array<Float>, itemSize:Int, normalized:Bool = false) {
		...
		this._updateRange = new haxe.ds.GenericMap();
		this._updateRange.set("offset", 0);
		this._updateRange.set("count", -1);
		this.updateRanges = [];
	...
	public function get updateRange():haxe.ds.GenericMap<String, Int> {
	...
	public function copy(source:BufferAttribute):BufferAttribute {
		...
		this.array = new Array<Float>(source.array);
	...
	public function clone():BufferAttribute {
		return new BufferAttribute(new Array<Float>(this.array), this.itemSize).copy(this);
	}
