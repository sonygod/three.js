...
class Quaternion {
	...
	private _onChangeCallback:() -> Void = null;
	...
	public function fromBufferAttribute(attribute:Dynamic, index:Int):Quaternion {
	...
	public function _onChange(callback:() -> Void):Quaternion {
	...
	public function iterator():Iterator<Float> {
		return new haxe.iterators.ArrayIterator([this._x, this._y, this._z, this._w]);
	}
}
