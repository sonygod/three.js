...
class Frustum {
    ...
    public function setFromProjectionMatrix(m:Matrix4, coordinateSystem:Int = WebGLCoordinateSystem):Frustum {
        ...
        if (coordinateSystem == WebGLCoordinateSystem) {
            ...
            throw "Frustum.setFromProjectionMatrix(): Invalid coordinate system: " + Std.string(coordinateSystem);
        }
    ...
    public function intersectsSprite(sprite:Sprite):Bool {
        var _sphere = new Sphere(new Vector3(0, 0, 0), 0.7071067811865476);
