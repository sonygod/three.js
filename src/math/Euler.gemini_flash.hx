import haxe.ui.backend.Float32Array;
import haxe.ui.backend.Int32Array;
...
class Euler {
	...
	private var _onChangeCallback:() -> Void = null;

	public static inline var DEFAULT_ORDER:String = "XYZ";
	...
	public function setFromQuaternion(q:Quaternion, order:String, update:Bool = true):Euler {
		var m = new Matrix4();
	...
	public function _onChangeCallback() {
	}

	public function iterator():Iterator<Float> {
		return new haxe.ds.GenericArrayIterator<Float>(new Float32Array([this._x, this._y, this._z]));
	}
