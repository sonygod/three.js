...
class Vector3 {
    ...
    public function project(camera:Camera) {
        return this.applyMatrix4(camera.matrixWorldInverse).applyMatrix4(camera.projectionMatrix);
    }

    public function unproject(camera:Camera) {
    ...
    public function divide(v:Vector3) {
        this.x /= v.x;
        this.y /= v.y;
        this.z /= v.z;
        return this;
    ...
    public function clampScalar(minVal:Float, maxVal:Float) {
    ...
    public function clampLength(min:Float, max:Float) {
    ...
    public function lerp(v:Vector3, alpha:Float) {
    ...
    public function lerpVectors(v1:Vector3, v2:Vector3, alpha:Float) {
    ...
    public function cross(v:Vector3) {
    ...
    public function projectOnPlane(planeNormal:Vector3) {
        var vector = this.clone().projectOnVector(planeNormal);
        return this.sub(vector);
    }

    public function reflect(normal:Vector3) {
        var vector = normal.clone().multiplyScalar(2 * this.dot(normal));
        return this.sub(vector);
    }
    ...
    public function setFromSpherical(s:Spherical) {
    ...
    public function setFromCylindrical(c:Cylindrical) {
    ...
    public function setFromMatrixScale(m:Matrix4) {
    ...
    public function setFromMatrixColumn(m:Matrix4, index:Int) {
        return this.fromArray(m.elements, index * 4);
    }

    public function setFromMatrix3Column(m:Matrix3, index:Int) {
        return this.fromArray(m.elements, index * 3);
    }

    public function setFromEuler(e:Euler) {
        this.x = e._x;
        this.y = e._y;
        this.z = e._z;
        return this;
    ...
    public function setFromColor(c:Color) {
        this.x = c.r;
        this.y = c.g;
        this.z = c.b;
        return this;
