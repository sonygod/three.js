...
class Frustum {
	...
	public function intersectsObject(object:Dynamic):Bool {
		...
		if (object.boundingSphere != null) {
			...
			sphere = new Sphere().copy(object.boundingSphere).applyMatrix4(object.matrixWorld);
		} else {
			var geometry = object.geometry;
			if (geometry.boundingSphere == null) geometry.computeBoundingSphere();
			sphere = new Sphere().copy(geometry.boundingSphere).applyMatrix4(object.matrixWorld);
		}
