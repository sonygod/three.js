...
class Box3 {
    ...
    public function setFromArray(array:Array<Float>):Box3 {
        ...
        for (i in 0...array.length / 3) {
            this.expandByPoint(_vector.fromArray(array, i * 3));
        }
        return this;
    }
    ...
    public function makeEmpty():Box3 {
        this.min.set(Math.POSITIVE_INFINITY, Math.POSITIVE_INFINITY, Math.POSITIVE_INFINITY);
        this.max.set(Math.NEGATIVE_INFINITY, Math.NEGATIVE_INFINITY, Math.NEGATIVE_INFINITY);
        return this;
    }
    ...
    public function satForAxes(axes:Array<Float>, v0:Vector3, v1:Vector3, v2:Vector3, extents:Vector3):Bool {
        for (i in 0...axes.length / 3) {
            _axis.fromArray(axes, i * 3);
            var r = extents.x * Math.abs(_axis.x) + extents.y * Math.abs(_axis.y) + extents.z * Math.abs(_axis.z);
            var p0 = v0.dot(_axis);
            var p1 = v1.dot(_axis);
            var p2 = v2.dot(_axis);
    ...
    public static var _points:Array<Vector3> = [
        new Vector3(), new Vector3(), new Vector3(), new Vector3(),
        new Vector3(), new Vector3(), new Vector3(), new Vector3()
    ];
    public static var _vector:Vector3 = new Vector3();
    public static var _box:Box3 = new Box3();
    public static var _plane:Plane = new Plane();
    public static var _tri:Triangle = new Triangle();
    public static var _center:Vector3 = new Vector3();
    public static var _extents:Vector3 = new Vector3();
    public static var _v0:Vector3 = new Vector3();
    public static var _v1:Vector3 = new Vector3();
    public static var _v2:Vector3 = new Vector3();
    public static var _f0:Vector3 = new Vector3();
    public static var _f1:Vector3 = new Vector3();
    public static var _f2:Vector3 = new Vector3();
    public static var _triangleNormal:Vector3 = new Vector3();
    public static var _axis:Vector3 = new Vector3();
}