...
class Vector2 {
    ...
    public var x:Float;
    public var y:Float;
    public static var isVector2:Bool = true;
    ...
    public function roundToZero():Vector2 {
        this.x = if (this.x < 0) Math.ceil(this.x) else Math.floor(this.x);
        this.y = if (this.y < 0) Math.ceil(this.y) else Math.floor(this.y);
        return this;
    }
