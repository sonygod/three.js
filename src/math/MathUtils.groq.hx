...
class MathUtils {
    ...
    public static function seededRandom(s:Int = 0):Float {
        if (s != 0) _seed = s;
    ...
    public static function setQuaternionFromProperEuler(q:Array<Float>, a:Float, b:Float, c:Float, order:String):Void {
        var cos = Math.cos;
        var sin = Math.sin;
        ...
        switch (order) {
            ...
            case 'ZYZ':
                ...
                q[3] = c2 * c13;
            default:
                throw new Error('THREE.MathUtils: .setQuaternionFromProperEuler() encountered an unknown order: ' + order);
        }
    }

    public static function denormalize(value:Float, array:Array<Dynamic>):Float {
        switch (array) {
    ...
    public static function normalize(value:Float, array:Array<Dynamic>):Float {
        switch (array) {
            case array is Float32Array:
                return value;
            case array is Uint32Array:
