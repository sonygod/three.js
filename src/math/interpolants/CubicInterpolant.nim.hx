...
class CubicInterpolant extends Interpolant {
	...
	public var _offsetPrev:Int = -0;
	public var _weightNext:Float = -0;
	public var _offsetNext:Int = -0;
	...
	public function new(parameterPositions:Array<Float>, sampleValues:Array<Dynamic>, sampleSize:Int, resultBuffer:Array<Float>) {
...
export.CubicInterpolant = CubicInterpolant;