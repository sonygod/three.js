...
class Ray {
    ...
    public function intersectSphere(sphere:Sphera, target:Vector3):Vector3 {
    ...
    public function intersectsSphere(sphere:Sphera):Bool {
    ...
    public function intersectTriangle(a:Vector3, b:Vector3, c:Vector3, backfaceCulling:Bool, target:Vector3):Vector3 {
        ...
        var DdQxE2 = sign * this.direction.dot(_edge2.cross(_diff, _edge2));
...
static var _segCenter = new Vector3();
static var _segDir = new Vector3();
static var _diff = new Vector3();
static var _edge1 = new Vector3();
static var _edge2 = new Vector3();
static var _normal = new Vector3();