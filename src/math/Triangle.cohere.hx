...
class Triangle {
    ...
    public static function getBarycoord(point:Vector3, a:Vector3, b:Vector3, c:Vector3, target:Vector3):Vector3 {
        var _v0 = Vector3._hx_new();
        var _v1 = Vector3._hx_new();
        var _v2 = Vector3._hx_new();
    ...
    public function closestPointToPoint(p:Vector3, target:Vector3):Vector3 {
        ...
        var _vab = Vector3._hx_new();
        var _vac = Vector3._hx_new();
        var _vap = Vector3._hx_new();
        var _vbp = Vector3._hx_new();
        var _vbc = Vector3._hx_new();
        var _vcp = Vector3._hx_new();
