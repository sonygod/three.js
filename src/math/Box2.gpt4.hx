...
class Box2 {
    ...
    public static var _vector:Vector2 = new Vector2();
    ...
    public function makeEmpty():Box2 {
        this.min.set(Math.POSITIVE_INFINITY, Math.POSITIVE_INFINITY);
        this.max.set(Math.NEGATIVE_INFINITY, Math.NEGATIVE_INFINITY);
        return this;
    }
