...
class Vector3 {
    ...
    public function distanceToManhattan(v:Vector3):Float {
        return Math.abs(this.x - v.x) + Math.abs(this.y - v.y) + Math.abs(this.z - v.z);
    }

    public function setFromSpherical(s:Sphere):Vector3 {
    ...
    public function setFromMatrixColumn(matrix:Matrix4, index:Int):Vector3 {
        return this.fromArray(matrix.elements, index * 4);
    }

    public function setFromMatrix3Column(matrix:Matrix3, index:Int):Vector3 {
