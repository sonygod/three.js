...
class Quaternion {
    ...
    static public function slerpFlat(dst:Array<Float>, dstOffset:Int, src0:Array<Float>, srcOffset0:Int, src1:Array<Float>, srcOffset1:Int, t:Float) {
    ...
    static public function multiplyQuaternionsFlat(dst:Array<Float>, dstOffset:Int, src0:Array<Float>, srcOffset0:Int, src1:Array<Float>, srcOffset1:Int) {
        var x0:Float = src0[srcOffset0];
        var y0:Float = src0[srcOffset0 + 1];
        var z0:Float = src0[srcOffset0 + 2];
        var w0:Float = src0[srcOffset0 + 3];
    ...
    public function angleTo(q:Quaternion) {
        return 2 * Math.acos(Math.abs(MathUtils.clamp(q.dot(this), -1, 1)));
    }
