...
class Quaternion {
	...
	public static function slerpFlat( dst : Float32Array, dstOffset : Int, src0 : Float32Array, srcOffset0 : Int, src1 : Float32Array, srcOffset1 : Int, t : Float )  : Void {
	...
	public static function multiplyQuaternionsFlat( dst : Float32Array, dstOffset : Int, src0 : Float32Array, srcOffset0 : Int, src1 : Float32Array, srcOffset1 : Int ) : Float32Array {
	...
	function get_x() : Float { return this._x; }
	...
	function get_y() : Float { return this._y; }
	...
	function get_z() : Float { return this._z; }
	...
	function get_w() : Float { return this._w; }
	...
	public function setFromEuler(euler : { var _x : Float; var _y : Float; var _z : Float; var _order : String; }, update : Bool = true) : Quaternion {
	...
	public function setFromAxisAngle(axis : { var x : Float; var y : Float; var z : Float; }, angle : Float) : Quaternion {
	...
	// Cannot convert setFromRotationMatrix.
	// It uses THREE.Matrix4 which is not provided.
	...
	*/
	...
	public function setFromUnitVectors(vFrom : { var x : Float; var y : Float; var z : Float; }, vTo : { var x : Float; var y : Float; var z : Float; }) : Quaternion {
	...
	public function fromArray(array : Array<Float>/*<Float>*/, offset : Int = 0) : Quaternion {
	...
	// Cannot convert fromBufferAttribute.
	// It uses THREE.BufferAttribute which is not provided.
	// You have to implement this function.
	/*
