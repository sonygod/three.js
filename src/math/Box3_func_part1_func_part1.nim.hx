        ...
        if (geometry !== null) {
            ...
            if (precise === true && positionAttribute !== null && object.isInstancedMesh !== true) {
                for (i in 0...positionAttribute.count) {
                    var vector:Vector3 = object.isMesh === true ? object.getVertexPosition(i) : Vector3.fromBufferAttribute(positionAttribute, i);
                    vector.applyMatrix4(object.matrixWorld);
                    this.expandByPoint(vector);
                }
            } else {
                var box:Box3 = object.boundingBox !== null ? object.boundingBox.clone() : geometry.boundingBox.clone();
