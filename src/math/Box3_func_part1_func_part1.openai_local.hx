...
class _Globals {
    ...
    public static var _box = new Box3();
    public static var _v0 = new Vector3();
    public static var _v1 = new Vector3();
    public static var _v2 = new Vector3();
    public static var _f0 = new Vector3();
    public static var _f1 = new Vector3();
    public static var _f2 = new Vector3();
    public static var _center = new Vector3();
    public static var _extents = new Vector3();
    public static var _triangleNormal = new Vector3();
    public static var _testAxis = new Vector3();
}

function satForAxes(axes:Array<Float>, v0:Vector3, v1:Vector3, v2:Vector3, extents:Vector3):Bool {
    for (i in 0...axes.length by 3) {
        _Globals._testAxis.fromArray(axes, i);
        var r = extents.x * Math.abs(_Globals._testAxis.x) + extents.y * Math.abs(_Globals._testAxis.y) + extents.z * Math.abs(_Globals._testAxis.z);
        var p0 = v0.dot(_Globals._testAxis);
        var p1 = v1.dot(_Globals._testAxis);
        var p2 = v2.dot(_Globals._testAxis);
