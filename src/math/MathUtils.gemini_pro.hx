...
class MathUtils {
    ...
    public static function generateUUID():String {
        var d0:Int = Math.random() * 0xffffffff | 0;
        var d1:Int = Math.random() * 0xffffffff | 0;
        var d2:Int = Math.random() * 0xffffffff | 0;
        var d3:Int = Math.random() * 0xffffffff | 0;
    ...
    public static function seededRandom(s:Int = -1):Float {
        if (s != -1) _seed = s;
    ...
    public static function denormalize(value:Int, array:Array<Dynamic>):Float {
    ...
    public static function normalize(value:Float, array:Array<Dynamic>):Int {
        switch array.constructor {
            case Float32Array:
                return value;
            case Int32Array:
