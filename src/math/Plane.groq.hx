...
class Plane {
    ...
    public function new(?normal:Vector3, ?constant:Float = 0) {
    ...
    public function setFromCoplanarPoints(a:Vector3, b:Vector3, c:Vector3):Plane {
        var normal:Vector3 = _vector1.subVectors(c, b).cross(_vector2.subVectors(a, b)).normalize();
    ...
    public function distanceToSphere(sphere:Dynamic):Float {
    ...
    public function intersectLine(line:Dynamic, target:Vector3):Vector3 {
        var direction:Vector3 = line.delta(_vector1);
    ...
    public function intersectsLine(line:Dynamic):Bool {
    ...
    public function applyMatrix4(matrix:Matrix4, ?optionalNormalMatrix:Matrix3):Plane {
        var normalMatrix:Matrix3 = optionalNormalMatrix != null ? optionalNormalMatrix : _normalMatrix.getNormalMatrix(matrix);

        var referencePoint:Vector3 = this.coplanarPoint(_vector1).applyMatrix4(matrix);
