...
class Plane {
    private var _vector1:Vector3 = new Vector3();
    private var _vector2:Vector3 = new Vector3();
    ...
    public function new(normal:Vector3 = null, constant:Float = 0.0) {
    ...
    public function applyMatrix4(matrix:Matrix4, optionalNormalMatrix:Matrix3 = null):Plane {
        var normalMatrix = optionalNormalMatrix != null ? optionalNormalMatrix : _normalMatrix.getNormalMatrix(matrix);
