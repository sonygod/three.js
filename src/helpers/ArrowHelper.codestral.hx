...
class ArrowHelper extends Object3D {
    ...
    private static var _axis: Vector3 = new Vector3();
    ...
    public function new(dir: Vector3 = new Vector3(0, 0, 1), origin: Vector3 = new Vector3(0, 0, 0), length: Float = 1, color: Int = 0xffff00, headLength: Float = length * 0.2, headWidth: Float = headLength * 0.2) {
        ...
        this.line = new Line(_lineGeometry, new LineBasicMaterial(color, false));
        this.line.matrixAutoUpdate = false;
        this.add(this.line);

        this.cone = new Mesh(_coneGeometry, new MeshBasicMaterial(color, false));
