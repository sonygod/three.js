...
class PolarGridHelper {
	public static function new(radius:Float = 10, sectors:Int = 16, rings:Int = 8, divisions:Int = 64, color1:Int = 0x444444, color2:Int = 0x888888) {
		return new PolarGridHelper(radius, sectors, rings, divisions, color1, color2);
	}
}