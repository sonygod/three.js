...
class LightShadow {
    ...
    private var normalBias:Float;
    private var radius:Float;
    private var blurSamples:Int;
    private var mapSize:Vector2;
    private var map:Dynamic;
    private var mapPass:Dynamic;
    ...
    public function updateMatrices(light:Dynamic):Void {
        var shadowCamera:Dynamic = this.camera;
    ...
    public function clone():LightShadow {
        return new LightShadow(this.copy(new LightShadow(this.camera)));
    }
