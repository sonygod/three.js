...
class Mesh extends Object3D {
    ...
    public function copy(source:Mesh, ?recursive:Bool):Mesh {
        ...
        if (source.morphTargetDictionary != null) {
            ...
            for (name in source.morphTargetDictionary.keys()) {
                this.morphTargetDictionary.set(name, source.morphTargetDictionary.get(name));
            }
        }

        this.material = if (Type.typeof(source.material) == TClass) source.material else source.material.copy();
...
private static function checkIntersection(object:Mesh, material:MeshBasicMaterial, raycaster:Raycaster, ray:Ray, pA:Vector3, pB:Vector3, pC:Vector3, point:Vector3):Dynamic {
    var intersect:Bool;
...
private static function checkGeometryIntersection(object:Mesh, material:MeshBasicMaterial, raycaster:Raycaster, ray:Ray, uv:BufferAttribute, uv1:BufferAttribute, normal:BufferAttribute, a:Int, b:Int, c:Int):Dynamic {
