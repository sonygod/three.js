...
class Mesh extends Object3D {
    ...
    var _normalA:Vector3;
    var _normalB:Vector3;
    var _normalC:Vector3;
    ...
    public function copy(source:Dynamic, recursive:Bool):Dynamic {
        ...
        if (source.morphTargetDictionary !== undefined) {
            this.morphTargetDictionary = Std.copy(source.morphTargetDictionary);
        }
        ...
        if (keys.length > 0) {
            ...
            if (morphAttribute !== undefined) {
                ...
                for (m in 0...morphAttribute.length) {
                    var name = (morphAttribute[m].name !== undefined ? morphAttribute[m].name : String(m));
