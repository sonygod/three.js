...
static var _geometry:BufferGeometry = null;
...
function transformVertex(vertexPosition:Vector3, mvPosition:Vector3, center:Vector2, scale:Vector3, sin:Float, cos:Float):Void {
