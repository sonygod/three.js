...
var _intersectPoint:Vector3 = new Vector3();
var _worldScale:Vector3 = new Vector3();
var _mvPosition:Vector3 = new Vector3();

var _alignedPosition:Vector2 = new Vector2();
var _rotatedPosition:Vector2 = new Vector2();
var _viewWorldMatrix:Matrix4 = new Matrix4();

var _vA:Vector3 = new Vector3();
var _vB:Vector3 = new Vector3();
var _vC:Vector3 = new Vector3();

var _uvA:Vector2 = new Vector2();
var _uvB:Vector2 = new Vector2();
var _uvC:Vector2 = new Vector2();
...
class Sprite extends Object3D {
    ...
    public function new(material:SpriteMaterial = new SpriteMaterial()) {
        ...
        if (_geometry == null) {
            ...
            var float32Array = new js.lib.Array<Float>([
                -0.5, -0.5, 0.0, 0.0, 0.0,
                0.5, -0.5, 0.0, 1.0, 0.0,
                0.5, 0.5, 0.0, 1.0, 1.0,
                -0.5, 0.5, 0.0, 0.0, 1.0
