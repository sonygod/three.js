...
class Points extends Object3D {
    ...
    public function copy(source:Points, recursive:Bool):Points {
        ...
        this.material = if (Type.typeof(source.material) == TClass(Array)) source.material.slice() else source.material;
...
function testPoint(point:Vector3, index:Int, localThresholdSq:Float, matrixWorld:Matrix4, raycaster:Raycaster, intersects:Array<Dynamic>, object:Points):Void {
