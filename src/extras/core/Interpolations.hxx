...
class Interpolations {
	static var CatmullRom:Dynamic;
	static var QuadraticBezier:Dynamic;
	static var CubicBezier:Dynamic;
}

Interpolations.CatmullRom = CatmullRom;
Interpolations.QuadraticBezier = QuadraticBezier;
Interpolations.CubicBezier = CubicBezier;