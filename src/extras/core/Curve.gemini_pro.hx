...
class Curve {
	...
	public function getPoint(t:Float, optionalTarget:Dynamic = null):Dynamic {
		Sys.warning("THREE.Curve: .getPoint() not implemented.");
		return null;
	}
	...
	public function getUtoTmapping(u:Float, distance:Float = null):Float {
		...
		var low = 0, high = il - 1, comparison:Float;
		while (low <= high) {
