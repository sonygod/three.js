...
class Curve {
	...
	public function getPoint( t:Float, optionalTarget:Dynamic ) {
	...
	public function getPointAt( u:Float, optionalTarget:Dynamic ) {
	...
	public function getPoints( divisions:Int = 5 ) {
	...
	public function getSpacedPoints( divisions:Int = 5 ) {
	...
	public function getLengths( divisions:Int = this.arcLengthDivisions ) {
	...
	public function getUtoTmapping( u:Float, distance:Float ) {
	...
	public function getTangent( t:Float, optionalTarget:Dynamic ) {
	...
	public function getTangentAt( u:Float, optionalTarget:Dynamic ) {
	...
	public function copy( source:Curve ) {
