...
class CurvePath extends Curve {
	...
	public var autoClose:Bool; // Automatically closes the path
	...
	public function closePath():CurvePath {
		...
		if (!startPoint.equals(endPoint)) {
			...
			this.curves.push(cast Curves[lineType](new Curves[lineType](endPoint, startPoint)));
		}
	...
	public function fromJSON(json:Dynamic):CurvePath {
		...
		for (i in 0...json.curves.length) {
			...
			this.curves.push(cast Curves[curve.type](new Curves[curve.type]()).fromJSON(curve));
		}
