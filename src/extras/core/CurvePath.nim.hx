...
class CurvePath extends Curve {
    ...
    public function closePath():CurvePath {
        ...
        if (!startPoint.equals(endPoint)) {
            ...
            this.curves.push(Type.createInstance(Type.resolveClass(lineType), [endPoint, startPoint]));
        }

        return this;
    }

    public function getPoint(t:Float, optionalTarget:Null<Curve>):Null<Curve> {
    ...
    public function getSpacedPoints(divisions:Int = 40):Array<Curve> {
        var points:Array<Curve> = [];
    ...
    public function getPoints(divisions:Int = 12):Array<Curve> {
        var points:Array<Curve> = [];
        var last:Curve;
    ...
    public function fromJSON(json:Dynamic):CurvePath {
        ...
        for (i in 0...json.curves.length) {
            ...
            this.curves.push(Type.createInstance(Type.resolveClass(curve.type), []).fromJSON(curve));
        }
