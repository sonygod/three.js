...
class DataUtils {
    ...
    private static function _generateTables():Dynamic {
        ...
        var buffer = new js.lib.ArrayBuffer(4);
        var floatView = new js.lib.Float32Array(buffer);
        var uint32View = new js.lib.Uint32Array(buffer);

        var baseTable = new js.lib.Uint32Array(512);
        var shiftTable = new js.lib.Uint32Array(512);
        ...
        var mantissaTable = new js.lib.Uint32Array(2048);
        var exponentTable = new js.lib.Uint32Array(64);
        var offsetTable = new js.lib.Uint32Array(64);
