...
class LineCurve3 extends Curve {
	...
	public var isLineCurve3:Bool = true;
	public var type:String = "LineCurve3";
	...
	public function getPoint(t:Float, optionalTarget:Vector3 = new Vector3()):Vector3 {
		if (t == 1) {
			return optionalTarget.copy(this.v2);
		} else {
			return optionalTarget.copy(this.v2).sub(this.v1).multiplyScalar(t).add(this.v1);
		}
	}
