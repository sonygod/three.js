...
class QuadraticBezierCurve extends Curve {
    ...
    public function new(v0:Vector2 = new Vector2(), v1:Vector2 = new Vector2(), v2:Vector2 = new Vector2()):Void {
        super();
    ...
    public function getPoint(t:Float, ?optionalTarget:Vector2 = null):Vector2 {
        ...
        point.set(
            QuadraticBezier.bezier(t, v0.x, v1.x, v2.x),
            QuadraticBezier.bezier(t, v0.y, v1.y, v2.y)
        );
