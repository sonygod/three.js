...
class TorusGeometry extends BufferGeometry {
    ...
    public function new(radius:Float = 1.0, tube:Float = 0.4, radialSegments:Int = 12, tubularSegments:Int = 48, arc:Float = Math.PI * 2) {
        super();
        ...
        // generate indices
        for ( var j:Int = 1; j <= radialSegments; j++ ) {
            for ( var i:Int = 1; i <= tubularSegments; i++ ) {
                // indices
    ...
    public function copy( source:TorusGeometry ):TorusGeometry {
        super.copy( source );
        this.parameters = Reflect.copyFields( source.parameters, this.parameters );
        return this;
    }
