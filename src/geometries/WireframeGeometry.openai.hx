...
typedef Set<T> = haxe.ds.StringMap<T>;

typedef Reflect = haxe.rtti.Reflect;

typedef Bool = haxe.rtti.Bool;

typedef String = js.js.String;

public var THREE = js.three.THREE;