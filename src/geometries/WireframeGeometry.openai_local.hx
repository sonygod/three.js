...
class WireframeGeometry extends BufferGeometry {
    ...
    public function new(geometry:BufferGeometry = null) {
        ...
        if (geometry != null) {
            ...
            var edges:haxe.ds.StringMap<Bool> = new haxe.ds.StringMap();
            ...
            if (geometry.index != null) {
                ...
                var position:Float32BufferAttribute = cast geometry.attributes.position;
    ...
    public override function copy(source:BufferGeometry):WireframeGeometry {
    ...
    private static function isUniqueEdge(start:Vector3, end:Vector3, edges:haxe.ds.StringMap<Bool>):Bool {
