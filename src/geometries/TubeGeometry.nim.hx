...
import Curves from '../extras/curves/Curves';
...
class TubeGeometry extends BufferGeometry {
    ...
    public var tangents:Dynamic;
    public var normals:Dynamic;
    public var binormals:Dynamic;
    ...
    public static function fromJSON(data:Dynamic):TubeGeometry {
        ...
        return new TubeGeometry(
            new Curves[Type.getClassName(data.path.type)]().fromJSON(data.path),
