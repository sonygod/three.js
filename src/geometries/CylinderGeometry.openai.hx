...
class CylinderGeometry extends BufferGeometry {
  ...
  public function new(radiusTop:Float = 1, radiusBottom:Float = 1, height:Float = 1, radialSegments:Int = 32, heightSegments:Int = 1, openEnded:Bool = false, thetaStart:Float = 0, thetaLength:Float = Math.PI * 2) {
    ...
    var radialSegments:Int = Math.floor(radialSegments);
    var heightSegments:Int = Math.floor(heightSegments);
  ...
  override public function copy(source:CylinderGeometry):CylinderGeometry {
    super.copy(source);
  ...
  static public function fromJSON(data:Dynamic):CylinderGeometry {
