...
class TubeGeometry extends BufferGeometry {
    ...
    public function new(path:Curves.QuadraticBezierCurve3 = new Curves.QuadraticBezierCurve3(new Vector3(-1, -1, 0), new Vector3(-1, 1, 0), new Vector3(1, 1, 0)), tubularSegments:Int = 64, radius:Float = 1, radialSegments:Int = 8, closed:Bool = false) {
        super();
    ...
    public static function fromJSON(data:Dynamic):TubeGeometry {
        ...
        return new TubeGeometry(
            new Reflect.field(Curves, data.path.type)().fromJSON(data.path),
