...
class BoxGeometry extends BufferGeometry {
	...
	public var type:String = 'BoxGeometry';
	...
	public function new(width:Float = 1, height:Float = 1, depth:Float = 1, widthSegments:Int = 1, heightSegments:Int = 1, depthSegments:Int = 1) {
		...
		function buildPlane(u:String, v:String, w:String, udir:Float, vdir:Float, width:Float, height:Float, depth:Float, gridX:Int, gridY:Int, materialIndex:Int):Void {
