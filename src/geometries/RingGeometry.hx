...
class RingGeometry extends BufferGeometry {
	...
	override public function copy(source:RingGeometry):RingGeometry {
		super.copy(source);

		this.parameters = { innerRadius: source.parameters.innerRadius, outerRadius: source.parameters.outerRadius, thetaSegments: source.parameters.thetaSegments, phiSegments: source.parameters.phiSegments, thetaStart: source.parameters.thetaStart, thetaLength: source.parameters.thetaLength };
