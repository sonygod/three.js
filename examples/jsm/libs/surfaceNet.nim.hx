...
class SurfaceNet {
    public static function surfaceNet(dims:Array<Int>, potential:(x:Float, y:Float, z:Float) -> Float, bounds:Array<Array<Float>>):Dynamic {
        ...
        var buffer:Array<Int> = Array.alloc(4096);
        (function() {
