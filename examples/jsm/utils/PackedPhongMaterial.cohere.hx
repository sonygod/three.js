...
import js.three.materials.MeshPhongMaterial;
...
class js__$PackedPhongMaterial {
    public static function __init__() {
        js.Browser.window.PackedPhongMaterial = PackedPhongMaterial;
    }
}