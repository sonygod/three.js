...
class Main {
	...
	static function main() {
		...
		var hilbert2DPoints = hilbert2D(new Vector3(0, 0, 0), 10, 3);
		var hilbert3DPoints = hilbert3D(new Vector3(0, 0, 0), 10, 3);
		var gosperPoints = gosper(1);

		trace(hilbert2DPoints);
		trace(hilbert3DPoints);
		trace(gosperPoints);
