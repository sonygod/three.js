...
class CameraUtils {
    private static var _va:Vector3 = new Vector3(); // from pe to pa
    private static var _vb:Vector3 = new Vector3(); // from pe to pb
    private static var _vc:Vector3 = new Vector3(); // from pe to pc
    private static var _vr:Vector3 = new Vector3(); // right axis of screen
    private static var _vu:Vector3 = new Vector3(); // up axis of screen
    private static var _vn:Vector3 = new Vector3(); // normal vector of screen
    private static var _vec:Vector3 = new Vector3(); // temporary vector
    private static var _quat:Quaternion = new Quaternion(); // temporary quaternion
     ...
     */
    public static function frameCorners(camera:PerspectiveCamera, bottomLeftCorner:Vector3, bottomRightCorner:Vector3, topLeftCorner:Vector3, estimateViewFrustum:Bool = false) {
