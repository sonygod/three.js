import three.js.extras.core.DoubleSide;
import three.js.extras.core.LinearFilter;
import three.js.extras.core.Mesh;
import three.js.extras.core.MeshBasicMaterial;
import three.js.extras.core.OrthographicCamera;
import three.js.extras.core.PlaneGeometry;
import three.js.extras.core.Scene;
import three.js.extras.core.ShaderMaterial;
import three.js.extras.core.Texture;
import three.js.extras.core.UniformsUtils;
import three.js.examples.jsm.shaders.UnpackDepthRGBAShader;
...
class ShadowMapViewer {
	...
	public function new( light:Dynamic ) {
		...
		this.size = {
			width: frame.width,
			height: frame.height,
			set: function ( width:Int, height:Int ) {
