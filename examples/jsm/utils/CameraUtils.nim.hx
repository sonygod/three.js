...
class CameraUtils {
    static private var _va:Vector3 = new Vector3(); // from pe to pa
    static private var _vb:Vector3 = new Vector3(); // from pe to pb
    static private var _vc:Vector3 = new Vector3(); // from pe to pc
    static private var _vr:Vector3 = new Vector3(); // right axis of screen
    static private var _vu:Vector3 = new Vector3(); // up axis of screen
    static private var _vn:Vector3 = new Vector3(); // normal vector of screen
    static private var _vec:Vector3 = new Vector3(); // temporary vector
    static private var _quat:Quaternion = new Quaternion(); // temporary quaternion
     ...
     * @param topLeftCorner
     * @param estimateViewFrustum */
    static public function frameCorners(camera:three.cameras.PerspectiveCamera, bottomLeftCorner:Vector3, bottomRightCorner:Vector3, topLeftCorner:Vector3, estimateViewFrustum:Bool = false):Void {
