class LWO3Parser {
    ...
    public function parseBlock() {
        var blockID = IFF.reader.getIDTag();
        var length = IFF.reader.getUint32();
        ...
        switch (blockID) {
            ...
            case "IMAG":
                var index = IFF.reader.getVariableLengthIndex();
            ...
            case "SMAN":
                var maxSmoothingAngle = IFF.reader.getFloat32();
            ...
            case "IMAP":
                IFF.currentSurface.attributes.imageMapIndex = IFF.reader.getUint32();
                break;
