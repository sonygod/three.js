import iff.IFFParser;

class LWO3Parser {
    private var IFF: IFFParser;
    ...
    public function parseBlock() {
        ...
        var blockID: String = this.IFF.reader.getIDTag();
        var length: Int = this.IFF.reader.getUint32(); // size of data in bytes
        ...
        switch (blockID) {
            ...
            case 'WRAP':
                ...
                break;
            case 'IMAG':
                var index: Int = this.IFF.reader.getVariableLengthIndex();
            ...
            case 'NNME':
                ...
                break;
            case 'INME':
                if (this.IFF.currentForm.nodeName == null) this.IFF.currentForm.nodeName = [];
                this.IFF.currentForm.nodeName.push(this.IFF.reader.getString());
                break;
            case 'IINN':
                if (this.IFF.currentForm.inputNodeName == null) this.IFF.currentForm.inputNodeName = [];
                this.IFF.currentForm.inputNodeName.push(this.IFF.reader.getString());
                break;
            case 'IINM':
                if (this.IFF.currentForm.inputName == null) this.IFF.currentForm.inputName = [];
                this.IFF.currentForm.inputName.push(this.IFF.reader.getString());
                break;
            case 'IONM':
                if (this.IFF.currentForm.inputOutputName == null) this.IFF.currentForm.inputOutputName = [];
            ...
            case 'CHAN':
                ...
                break;
            case 'SMAN':
                var maxSmoothingAngle: Float = this.IFF.reader.getFloat32();
