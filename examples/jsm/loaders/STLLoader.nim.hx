...
class STLLoader extends Loader {
	...
	public function parse(data:Dynamic) {
		...
		function isBinary(data:Dynamic) {
		...
		function matchDataViewAt(query:Array<Int>, reader:Dynamic, offset:Int) {
		...
		function parseBinary(data:Dynamic) {
			...
			var r:Float, g:Float, b:Float, hasColors = false, colors:Dynamic;
			...
			while ((result = patternSolid.exec(data)) != null) {
				...
				while ((result = patternFace.exec(solid)) != null) {
					...
					if (normalCountPerFace != 1) {
						...
						js.Lib.console.error("THREE.STLLoader: Something isn't right with the normal of face number " + faceCounter);
					...
					if (vertexCountPerFace != 3) {
						...
						js.Lib.console.error("THREE.STLLoader: Something isn't right with the vertices of face number " + faceCounter);
		...
		function ensureString(buffer:Dynamic) {

			if (Type.typeof(buffer) != TString) {
		...
		function ensureBinary(buffer:Dynamic) {
