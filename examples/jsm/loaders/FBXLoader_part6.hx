...
class BinaryParser
{
    ...
    public function parse(buffer:BytesInput):FBXTree
    {
    ...
    function parseNode(reader:BinaryReader, version:Int):Dynamic
    {
        var node = {};
    ...
    function parseSubNode(name:String, node:Dynamic, subNode:Dynamic):Void
    {
        ...
        if (subNode.singleProperty) {
            ...
            for (property in subNode.propertyList) {
                ...
                if (property != 0) array.push(property);
            }
...
class FBXTree
{
    ...
    public function add(name:String, node:Dynamic):Void
    {
        nodes.set(name, node);
    }
}