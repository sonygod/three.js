import three.js.examples.jsm.loaders.TDSLoader;
import three.js.examples.jsm.loaders.FileLoader;
import three.js.examples.jsm.loaders.LoaderUtils;
...
import three.js.examples.jsm.materials.MeshPhongMaterial;
...
class TDSLoader extends Loader {
    ...
    public function readMaterialGroup(chunk:Chunk):Dynamic {
        var name = chunk.readString();
