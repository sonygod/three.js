...
class Line {
    static var uniforms : js.Dynamic = {
        worldUnits: { value: 1 },
        linewidth: { value: 1 },
...
class LineMaterial extends ShaderMaterial {
    public function new(parameters:js.Dynamic) {
        super({
            type: 'LineMaterial',
    ...
    public function get_color():js.Dynamic {
        return this.uniforms.diffuse.value;
    }

    public function set_color(value:js.Dynamic) {
    ...
    public function get_dashOffset():Float {
        return this.uniforms.dashOffset.value;
    }

    public function set_dashOffset(value:Float) {
