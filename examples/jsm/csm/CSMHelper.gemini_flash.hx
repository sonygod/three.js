...
class CSMHelper extends Group {
	...
	public var csm(default, null):Dynamic;
	public var displayFrustum(default, null):Bool;
	public var displayPlanes(default, null):Bool;
	public var displayShadowBounds(default, null):Bool;
	public var frustumLines(default, null):LineSegments;
	public var cascadeLines(default, null):Array<Box3Helper>;
	public var cascadePlanes(default, null):Array<Mesh>;
	public var shadowLines(default, null):Array<Group>;

	public function new(csm) {
	...
	public function update():Void {
		...
		var frustumLines = this.frustumLines;
		var frustumLinePositions = cast(frustumLines.geometry.getAttribute('position'), BufferAttribute);
		var cascadeLines = this.cascadeLines;
		var cascadePlanes = this.cascadePlanes;
		var shadowLines = this.shadowLines;
		...
		for (i in 0...cascades) {
			...
			var cascadePlane = cascadePlanes[i];
			var shadowLineGroup = shadowLines[i];
			var shadowLine = cast(shadowLineGroup.children[0], Box3Helper);
