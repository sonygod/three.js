...
class CSMHelper extends Group {
    ...
    public function updateVisibility():Void {
        ...
        for (var i:Int in 0...cascadeLines.length) {
...
// Export
// Note: Haxe doesn't support exporting classes like JavaScript does.
// You can use the class directly in your project.