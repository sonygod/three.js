...
class SelectionBox {
    ...
    private var _tmpPoint:Vector3 = new Vector3();

    private var _vecNear:Vector3 = new Vector3();
    private var _vecTopLeft:Vector3 = new Vector3();
    private var _vecTopRight:Vector3 = new Vector3();
    private var _vecDownRight:Vector3 = new Vector3();
    private var _vecDownLeft:Vector3 = new Vector3();

    private var _vecFarTopLeft:Vector3 = new Vector3();
    private var _vecFarTopRight:Vector3 = new Vector3();
    private var _vecFarDownRight:Vector3 = new Vector3();
    private var _vecFarDownLeft:Vector3 = new Vector3();

    private var _vectemp1:Vector3 = new Vector3();
    private var _vectemp2:Vector3 = new Vector3();
    private var _vectemp3:Vector3 = new Vector3();
    ...
    private function updateFrustum(startPoint:Vector3, endPoint:Vector3):Void {
    ...
    private function searchChildInFrustum(frustum:Frustum, object:Dynamic):Void {
...
```
Note that I've used the `Math` class for mathematical operations, and `trace` for debugging purposes. Also, I've used `Map` and `Array` classes from the Haxe standard library.