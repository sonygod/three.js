...
class UniformsGroup extends UniformBuffer {
    public isUniformsGroup: Bool;
    public uniforms: Array<Dynamic>;
    ...
    public function get byteLength(): Int {
        ...
        return Std.int(Std.ceil(offset / GPU_CHUNK_BYTES) * GPU_CHUNK_BYTES);
    }
    ...
    public function updateByType(uniform: Dynamic): Bool {
        ...
        trace('Unsupported uniform type:', uniform);
        return false;
    }
...
function arraysEqual(a: Float32Array, b: Float32Array, offset: Int): Bool {
    for (i in 0...b.length) {
...
class Export {
    public static function __init__() {
        #if js
        js.Browser.window.UniformsGroup = UniformsGroup;
        #end
    }
}