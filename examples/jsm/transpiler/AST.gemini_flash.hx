...
class VariableDeclaration {
	...
	public var next:Dynamic = null;
	public var immutable:Bool = false;
	public var isVariableDeclaration:Bool = true;

	public function new(type:String, name:String, value:Dynamic = null, next:Dynamic = null, immutable:Bool = false) {
		this.type = type;
		this.name = name;
		this.value = value;
		this.next = next;
...
class FunctionParameter {
	public var type:String;
	public var name:String;
	public var qualifier:Dynamic = null;
	public var immutable:Bool = true;
	public var isFunctionParameter:Bool = true;

	public function new(type:String, name:String, qualifier:Dynamic = null, immutable:Bool = true) {
		this.type = type;
		this.name = name;
...
class Conditional {
	public var cond:Dynamic = null;
	public var body:Array<Dynamic>;
	public var elseConditional:Dynamic = null;
