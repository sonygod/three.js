import three.js.examples.jsm.postprocessing.OutlinePass;
...
import three.js.examples.jsm.utils.Matrix4;
import three.js.examples.jsm.utils.Vector2;
import three.js.examples.jsm.utils.Vector3;
import three.js.examples.jsm.utils.WebGLRenderTarget;
import three.js.examples.jsm.utils.Color;
import three.js.examples.jsm.materials.MeshDepthMaterial;
import three.js.examples.jsm.materials.ShaderMaterial;
import three.js.examples.jsm.constants.AdditiveBlending;
import three.js.examples.jsm.constants.NoBlending;
import three.js.examples.jsm.constants.RGBADepthPacking;
import three.js.examples.jsm.constants.DoubleSide;
...
class OutlinePass extends Pass {
    ...
    public function new(resolution:Vector2, scene:Scene, camera:Camera, selectedObjects:Array<Object3D>) {
        super();
    ...
    public function changeVisibilityOfNonSelectedObjects(bVisible:Bool) {
        var cache = this._visibilityCache;
        var selectedMeshes:Array<Object3D> = [];
        function gatherSelectedMeshesCallBack(object:Object3D) {
    ...
    public function getPrepareMaskMaterial() {
    ...
    public function getEdgeDetectionMaterial() {
        return new ShaderMaterial({
            uniforms: {
    ...
    public function getSeperableBlurMaterial(maxRadius:Int) {
        return new ShaderMaterial({
            defines: {
    ...
    public function getOverlayMaterial() {
        return new ShaderMaterial({
            uniforms: {
                'maskTexture': { value: null },
