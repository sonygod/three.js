import three.core.HalfFloatType;
...
class AfterimagePass extends Pass {
    ...
    public function new(damp: Float = 0.96) {
        ...
        this.shader = AfterimageShader.getInstance();
    ...
    public function render(renderer, writeBuffer: WebGLRenderTarget, readBuffer: WebGLRenderTarget/*, deltaTime, maskActive*/) {
