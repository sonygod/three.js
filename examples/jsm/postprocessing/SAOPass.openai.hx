...
import three.js.*;
import three.js.examples.jsm.Pass;
...
class SAOPass extends Pass {
    ...
    public var params:{ output:Int, saoBias:Float, saoIntensity:Float, saoScale:Float, saoKernelRadius:Float, saoMinResolution:Float, saoBlur:Bool, saoBlurRadius:Float, saoBlurStdDev:Float, saoBlurDepthCutoff:Float };
    ...
    public function renderPass(renderer:WebGLRenderer, passMaterial:ShaderMaterial, renderTarget:WebGLRenderTarget, clearColor:UInt, clearAlpha:Float) {
    ...
    public function renderOverride(renderer:WebGLRenderer, overrideMaterial:ShaderMaterial, renderTarget:WebGLRenderTarget, clearColor:UInt, clearAlpha:Float) {
        renderer.getClearColor(this.originalClearColor);
        var originalClearAlpha = renderer.getClearAlpha();
        var originalAutoClear = renderer.autoClear;
        renderer.setRenderTarget(renderTarget);
