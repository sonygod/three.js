...
class SAOPass extends Pass {
    ...
    public var params:{
        ...
        saoIntensity:Float,
        saoScale:Float,
        saoKernelRadius:Float,
        saoMinResolution:Float,
        saoBlur:Bool,
        saoBlurRadius:Int,
        saoBlurStdDev:Float,
        saoBlurDepthCutoff:Float
    };
    ...
    public function new(scene:Scene, camera:Camera, resolution:Vector2 = new Vector2(256, 256)) {
        ...
        this.saoRenderTarget = new WebGLRenderTarget(resolution.x, resolution.y, { type: HalfFloatType } );
        ...
        this.normalRenderTarget = new WebGLRenderTarget(resolution.x, resolution.y, {
    ...
    public function render(renderer:WebGLRenderer, writeBuffer:WebGLRenderTarget, readBuffer:WebGLRenderTarget, deltaTime:Float = 0, maskActive:Bool = false):Void {
    ...
    public function renderPass(renderer:WebGLRenderer, passMaterial:ShaderMaterial, renderTarget:WebGLRenderTarget, clearColor:Int = 0, clearAlpha:Float = 0.0):Void {
        // save original state
    ...
    public function renderOverride(renderer:WebGLRenderer, overrideMaterial:ShaderMaterial, renderTarget:WebGLRenderTarget, clearColor:Int = 0, clearAlpha:Float = 0.0):Void {
        renderer.getClearColor(this.originalClearColor);
        const originalClearAlpha = renderer.getClearAlpha();
        const originalAutoClear = renderer.autoClear;
