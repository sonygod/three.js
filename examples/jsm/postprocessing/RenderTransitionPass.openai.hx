...
import three.js renderers.gl.GLType;
import three.js.renderers.gl.ShaderMaterial;
import three.js.renderers.gl.WebGLRenderTarget;
import three.js.scenes.Scene;
import three.js.cameras.Camera;
import three.js.utils.Pass;
import three.js.utils.FullScreenQuad;
...
class RenderTransitionPass extends Pass {
    ...
    public function new(sceneA:Scene, cameraA:Camera, sceneB:Scene, cameraB:Camera) {
        ...
        renderTargetA.texture.type = GLType.HalfFloat;
        renderTargetB = new WebGLRenderTarget();
        renderTargetB.texture.type = GLType.HalfFloat;
    }
