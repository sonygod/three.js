...
class TAARenderPass extends SSAARenderPass {
    ...
    override public function render(renderer:Renderer, writeBuffer:WebGLRenderTarget, readBuffer:WebGLRenderTarget, deltaTime:Float) {
        if (!accumulate) {
        ...
        var jitterOffsets:Array<Array<Int>> = _JitterVectors[5];
        ...
        if (accumulateIndex >= 0 && accumulateIndex < jitterOffsets.length) {
            ...
            for (i in 0...numSamplesPerFrame) {
                ...
                var jitterOffset:Array<Int> = jitterOffsets[j];
...
var _JitterVectors:Array<Array<Array<Int>>> = [
    [
        [0, 0]
    ],
    [
