...
class RenderPass extends Pass {
    ...
    public var clearColor:NullIColor;
    ...
    public function new(scene:Dynamic, camera:Dynamic, overrideMaterial:Dynamic = null, clearColor:NullIColor = null, clearAlpha:Null<Float> = null) {
        super();
        this.scene = scene;
        this.camera = camera;
    ...
    public function render(renderer:Dynamic, writeBuffer:Dynamic, readBuffer:Dynamic /*, deltaTime:Float, maskActive:Bool*/):Void {
        ...
        var oldClearAlpha:Null<Float>, oldOverrideMaterial:Dynamic;
