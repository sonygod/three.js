...
class EdgeSplitModifier {
    ...
    public function modify( geometry:BufferGeometry, cutOffAngle:Float, tryKeepNormals:Bool = true ):BufferGeometry {
        ...
        function computeNormals() {
            ...
            for ( i in 0...indexes.length by 3 ) {
        ...
        function mapPositionsToIndexes() {
            ...
            var pointToIndexMap = new Array<Int>();
        ...
        function edgeSplitToGroups( indexes:Array<Int>, cutOff:Float, firstIndex:Int ) {
        ...
        var pointToIndexMap = mapPositionsToIndexes();
        ...
        var newAttributes = new Map<String, BufferAttribute>();
        for ( name in geometry.attributes.keys() ) {

            var oldAttribute = geometry.attributes.get(name);
        ...
        if ( hadNormals ) {
            ...
            if ( oldNormals != null ) {
                ...
                var changedNormals = new Array<Bool>();
...
export default EdgeSplitModifier;