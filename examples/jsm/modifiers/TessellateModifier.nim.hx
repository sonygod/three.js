import three.js.examples.jsm.modifiers.TessellateModifier;
        ...
        while (tessellating && iteration < maxIterations) {
            ...
            for (i in 0...positions.length) {
                ...
                if (hasUVs) {
                    ...
                    ua.fromArray(uvs, i * 2 + 0);
                    ub.fromArray(uvs, i * 2 + 2);
                    uc.fromArray(uvs, i * 2 + 4);

                }

                if (hasUV1s) {

                    u2a.fromArray(uv1s, i * 2 + 0);
                    u2b.fromArray(uv1s, i * 2 + 2);
                    u2c.fromArray(uv1s, i * 2 + 4);
