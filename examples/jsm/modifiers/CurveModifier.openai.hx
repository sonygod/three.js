package three.js.examples.jim.modifiers;
...
class CurveModifier {
    ...
    static function modifyShader(material:Material, uniforms, numberOfCurves:Int = 1) {
        ...
        material.onBeforeCompile = (shader) -> {
            ...
            shader.uniforms.extend(uniforms);
...
class Flow {
    ...
    var splineTexture:DataTexture;
    var uniforms:Dynamic;

    public function new(mesh:Mesh, numberOfCurves:Int = 1) {
        var obj3D:Object3D = mesh.clone();
        var splineTexture = initSplineTexture(numberOfCurves);
        var uniforms = getUniforms(splineTexture);
...
class InstancedFlow extends Flow {
    ...
    public function new(count:Int, curveCount:Int, geometry:Geometry, material:Material) {
        ...
        super(new Mesh(geometry, material), curveCount);
