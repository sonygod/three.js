import three.js.extras.core.Side;
...
class RoomEnvironment extends Scene {
    ...
    public function new(renderer:Null<Dynamic> = null) {
        ...
        var roomMaterial = new MeshStandardMaterial({side: Side.BackSide});
    ...
    public function dispose() {
        ...
        var resources = new Set<Dynamic>();

        this.traverse((object:Dynamic) -> {
...
function createAreaLightMaterial(intensity:Float) {
