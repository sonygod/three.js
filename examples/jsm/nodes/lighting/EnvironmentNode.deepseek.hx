...
class EnvironmentNode extends LightingNode {
	...
	static function createRadianceContext(roughnessNode:Dynamic, normalViewNode:Dynamic):Dynamic {
		var reflectVec = null;
		return {
			getUV: function() {
				if (reflectVec === null) {
	...
	static function createIrradianceContext(normalWorldNode:Dynamic):Dynamic {
		return {
			getUV: function() {
