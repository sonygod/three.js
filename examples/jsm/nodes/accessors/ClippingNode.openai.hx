...
class ClippingNode extends Node {
    ...
    public static inline var ALPHA_TO_COVERNAGE:String = 'alphaToCoverage';
...
class Clipping extends ClippingNode {
    public function new() {
        super();
    }
}

class ClippingAlpha extends ClippingNode {
    public function new() {
        super(ALPHA_TO_COVERNAGE);
    }
}