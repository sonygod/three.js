...
class BatchNode extends Node {
	...
	public var batchMesh:BatchMesh;

	public var instanceColorNode:Null<Node>;

	public var batchingIdNode:Null<Node>;

	public function new(batchMesh:BatchMesh) {
	...
	public function setup(builder:ShaderBuilder) {
