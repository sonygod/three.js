...
class ToneMappingNode extends TempNode {
  public toneMapping: Dynamic<Int>;
  public exposureNode: Dynamic<Node>;
  public colorNode: Dynamic<Node>;

  public constructor(toneMapping: Dynamic<Int> = NoToneMapping, exposureNode: Dynamic<Node> = toneMappingExposure, colorNode: Dynamic<Node> = null) {
    super("vec3");
  ...
  public setup(builder: Dynamic<NodeBuilder>): Dynamic<Node> {
    ...
    let outputNode: Dynamic<Node> = null;
...
export const toneMapping = (mapping: Dynamic<Int>, exposure: Dynamic<Node>, color: Dynamic<Node>) => nodeObject(new ToneMappingNode(mapping, nodeObject(exposure), nodeObject(color)));
export const toneMappingExposure = rendererReference("toneMappingExposure", "float");

addNodeElement("toneMapping", (color: Dynamic<Node>, mapping: Dynamic<Int>, exposure: Dynamic<Node>) => toneMapping(mapping, exposure, color));
