package three.examples.javascript.effects;
...
class AnaglyphEffect {
    ...
    public var stereo:StereoCamera;
    public var renderTargetL:WebGLRenderTarget;
    public var renderTargetR:WebGLRenderTarget;
