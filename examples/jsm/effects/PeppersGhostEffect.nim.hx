...
class PeppersGhostEffect {
	...
	private var _cameraF:PerspectiveCamera = new PerspectiveCamera(); //front
	private var _cameraB:PerspectiveCamera = new PerspectiveCamera(); //back
	private var _cameraL:PerspectiveCamera = new PerspectiveCamera(); //left
	private var _cameraR:PerspectiveCamera = new PerspectiveCamera(); //right
