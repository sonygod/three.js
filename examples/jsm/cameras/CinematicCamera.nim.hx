...
import three.js.extras.core.Scene;
import three.js.extras.materials.ShaderMaterial;
import three.js.extras.geometries.PlaneGeometry;
import three.js.extras.cameras.OrthographicCamera;
import three.js.extras.renderers.WebGLRenderTarget;
import three.js.extras.shaders.BokehShader;
import three.js.extras.shaders.BokehDepthShader;
import three.js.extras.objects.Mesh;

class CinematicCamera extends PerspectiveCamera {

	public var postprocessing(default, default):{ enabled:Bool; scene:Scene; camera:OrthographicCamera; rtTextureDepth:WebGLRenderTarget; rtTextureColor:WebGLRenderTarget; bokeh_uniforms:Dynamic; materialBokeh:ShaderMaterial; quad:Mesh; } = { enabled: true };
	public var shaderSettings(default, default):{ rings:Int; samples:Int; } = { rings: 3, samples: 4 };
