import three.extras.geometries.ConvexGeometry;
...
class ConvexObjectBreaker {
	...
	public function subdivideByImpact(object:Mesh, pointOfImpact:Vector3, normal:Vector3, maxRadialIterations:Int, maxRandomIterations:Int):Array<Mesh> {
		var debris:Array<Mesh> = new Array<Mesh>();
	...
	public function cutByPlane(object:Mesh, plane:Plane, output:Dynamic):Int {
		...
		var points1:Array<Vector3> = new Array<Vector3>();
		var points2:Array<Vector3> = new Array<Vector3>();
		...
		for (var i = 0; i < numFaces; i++) {
			...
			for (var segment = 0; segment < 3; segment++) {
				...
				if ((mark0 == 1 && mark1 == 2) || (mark0 == 2 && mark1 == 1)) {
					...
					var intersection:Vector3 = localPlane.intersectLine(this.tempLine1);
	...
	static function transformFreeVector(v:Vector3, m:Dynamic):Vector3 {
		// input:
	...
	static function transformFreeVectorInverse(v:Vector3, m:Dynamic):Vector3 {
		// input:
		// vector interpreted as a free vector
		// THREE.Matrix4 orthogonal matrix (matrix without scale)
	...
	static function transformTiedVectorInverse(v:Vector3, m:Dynamic):Vector3 {
		// input:
	...
	static function transformPlaneToLocalSpace(plane:Plane, m:Dynamic, resultPlane:Plane) {
