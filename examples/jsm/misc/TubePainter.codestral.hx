...
class TubePainter {
    private var BUFFER_SIZE:Int = 1000000 * 3;
    ...
    public function new() {
        positions = new BufferAttribute(new Float(BUFFER_SIZE), 3);
        positions.usage = DynamicDrawUsage;

        normals = new BufferAttribute(new Float(BUFFER_SIZE), 3);
        normals.usage = DynamicDrawUsage;

        colors = new BufferAttribute(new Float(BUFFER_SIZE), 3);
