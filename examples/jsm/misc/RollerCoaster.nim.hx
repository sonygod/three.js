...
import three.js.examples.jsm.objects.BufferGeometry;
import three.js.examples.jsm.objects.BufferAttribute;

class RollerCoasterGeometry extends BufferGeometry {

	public function new(curve:Dynamic, divisions:Dynamic) {
		...
		function drawShape(shape:Array<Dynamic>, color:Array<Dynamic>) {
		...
		function extrudeShape(shape:Array<Dynamic>, offset:Vector3, color:Array<Dynamic>) {
...
class RollerCoasterLiftersGeometry extends BufferGeometry {
	...
	public function new(curve:Dynamic, divisions:Dynamic) {
		...
		function extrudeShape(shape:Array<Dynamic>, fromPoint:Vector3, toPoint:Vector3) {
...
class TreesGeometry extends BufferGeometry {
	...
	public function new(landscape:Dynamic) {
