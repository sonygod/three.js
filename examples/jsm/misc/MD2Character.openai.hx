...
class MD2Character {
    ...
    public function loadParts(config:Dynamic) {
        ...
        loader.load(config.baseUrl + config.body, function(geo) {
            ...
            activeAnimationClipName = mesh.geometry.animations[0].name;
    ...
    public function setAnimation(clipName:String) {
        ...
        activeAnimationClipName = clipName;

        syncWeaponAnimation();
    }

    public function syncWeaponAnimation() {
        var clipName = activeAnimationClipName;
...
// Export the class
#if js
@:jsRequire("three/examples/jsm/misc/MD2Character", "MD2Character")
#end