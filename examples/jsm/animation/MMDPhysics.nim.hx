...
import three.js.extras.geometries.BoxGeometry;
import three.js.extras.geometries.CapsuleGeometry;
...
class MMDPhysics {
	...
	/**
	 * @param mesh
	 * @param rigidBodyParams
	 * @param constraintParams
	 * @param params
	 */
	public function new(mesh:Mesh, rigidBodyParams:Array<Dynamic>, constraintParams:Array<Dynamic>, params:Dynamic) {

		if (Type.typeof(Ammo) != TDynamic) {
	...
	private function _init(mesh:Mesh, rigidBodyParams:Array<Dynamic>, constraintParams:Array<Dynamic>) {
...
class RigidBody {
	 ...
	 * @param manager
	 */
	public function new(mesh:Mesh, world:Ammo.btDiscreteDynamicsWorld, params:Dynamic, manager:ResourceManager) {
...
class Constraint {
	 ...
	 * @param manager
	 */
	public function new(mesh:Mesh, world:Ammo.btDiscreteDynamicsWorld, bodyA:RigidBody, bodyB:RigidBody, params:Dynamic, manager:ResourceManager) {
...
class MMDPhysicsHelper extends Object3D {
	 ...
	 * @param physics
	 */
	public function new(mesh:Mesh, physics:MMDPhysics) {
