 ...
 *  exporter.parse(mesh, function(data) console.log(data), { binary: true, excludeAttributes: [ 'color' ], littleEndian: true });
 *
 * Format Definition:
...
class PLYExporter {
	...
	public function parse(object:Dynamic, onDone:Dynamic, options:Dynamic) {
		...
		if (typeof onDone === 'function') requestAnimationFrame(function() onDone(result));
