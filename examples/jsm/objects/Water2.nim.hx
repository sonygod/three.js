...
import three.js.objects.Reflector;
import three.js.objects.Refractor;
...
class Water extends Mesh {
	...
	public function new(geometry:Dynamic, options:Dynamic) {
		...
		var flowMap = options.flowMap || null;
		...
		function updateTextureMatrix(camera:Dynamic) {
