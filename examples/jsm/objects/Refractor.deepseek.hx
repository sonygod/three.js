...
class Refractor extends Mesh {
	...
	public function new(geometry:Dynamic, options:Dynamic = {}) {
		...
		var visible = function() {
			...
			return function(camera:Dynamic) {
		...
		function render(renderer:Dynamic, scene:Dynamic, camera:Dynamic) {
			scope.visible = false;
			...
			if (viewport != null) renderer.state.viewport(viewport);
