package three.examples.jsm.objects;
...
import three.examples.jsm.objects.Reflector;
import three.examples.jsm.objects.Refractor;
...
class Water extends Mesh {
	...
	public function new(geometry, options:Dynamic = {}) {
		...
		var flowDirection = options.flowDirection !== undefined ? options.flowDirection : new Vector2(1, 0);
		var flowSpeed = options.flowSpeed !== undefined ? options.flowSpeed : 0.03;
		var reflectivity = options.reflectivity !== undefined ? options.reflectivity : 0.02;
		var scale = options.scale !== undefined ? options.scale : 1;
		var shader = options.shader !== undefined ? options.shader : Water.WaterShader;
...
class WaterShader {
	...
	public static var WaterShader:Dynamic = {
