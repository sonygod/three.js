...
class Lensflare extends Mesh {
	...
	public var renderOrder:Int = Int.MAX_VALUE;

	public static var Geometry:BufferGeometry = function() {
	...
	public function new() {
		...
		var currentType:Int = UnsignedByteType;
		...
		var elements:Array<LensflareElement> = [];
		...
		this.addElement = function(element:LensflareElement) {
		...
		this.onBeforeRender = function(renderer, scene, camera) {
			...
			var type:Int = (renderTarget != null) ? renderTarget.texture.type : UnsignedByteType;
...
class LensflareElement {
	...
	public var texture:FramebufferTexture;
	public var size:Float;
	public var distance:Float;
	public var color:Color;

	public function new(texture:FramebufferTexture, size:Float = 1, distance:Float = 0, color:Color = new Color(0xffffff)) {
...
class Shader {
	...
	public var uniforms:Map<String, {value:Dynamic}>;
