class ArcballControls {
    ...
    private var _curvePts:Int = 32;
    private var _gizmos:Object; // Assuming this is a three.js Object3D
    private var _changeEvent:Event; // Assuming this is a three.js Event
    ...
    private var camera:Camera; // Assuming this is a three.js Camera
    ...
    private var minFov:Float = 1;
    private var maxFov:Float = 179;
    private var minZoom:Float = 0.01;
    private var maxZoom:Float = 1000;
    ...
    private var _transformation:Object = { camera: null, gizmos: null };
    ...
    // Assuming STATE is defined somewhere
    private var _timeStart:Float = -1;
    private var _state:Int;
    private var focusAnimationTime:Float;
    private var scaleFactor:Float;
    private var _animationId:Int = -1;
    private var easeOutCubic:Function; // Assuming this is a function
    ...
    private var dampingFactor:Float;
    ...
    public function pan(p0:Vector3, p1:Vector3, adjust:Bool = false):Object {
    ...
    public function rotate(axis:Vector3, angle:Float):Object {
    ...
    public function scale(size:Float, point:Vector3, scaleGizmos:Bool = true):Object {
