...
class GouraudShader {
	...
	public var name: String = 'GouraudShader';

	public var uniforms: Dynamic<Map<String, js.three.IUniform>> = UniformsUtils.merge([
		UniformsLib.common,
...
class MeshGouraudMaterial extends ShaderMaterial {
	...
	public function new(parameters: Dynamic<Map<String, js.three.IUniform>> = null) {
		super();

		this.isMeshGouraudMaterial = true;
		this.type = 'MeshGouraudMaterial';

		this.defines = GouraudShader.define;
