...
class MeshPostProcessingMaterial extends MeshPhysicalMaterial {
    ...
    public function new(parameters:Dynamic) {
        aoPassMap = parameters.aoPassMap;
...
private var aomap_pars_fragment_replacement:String = /* glsl */'
#ifdef USE_AOMAP
...
private var aomap_fragment_replacement:String = /* glsl */'
