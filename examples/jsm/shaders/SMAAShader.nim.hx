import three.js.examples.jsm.shaders.SMAAShader;
...
class SMAAEdgesShader {
    ...
    public static var name:String = 'SMAAEdgesShader';
...
class SMAAWeightsShader {
    ...
    public static var name:String = 'SMAAWeightsShader';
...
class SMAABlendShader {
    ...
    public static var name:String = 'SMAABlendShader';
