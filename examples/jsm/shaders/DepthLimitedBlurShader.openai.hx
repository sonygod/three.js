...
class DepthLimitedBlurShader {
  ...
  public static var defines:Map<String, Int> = [
    'KERNEL_RADIUS' => 4,
    'DEPTH_PACKING' => 1,
...
class BlurShaderUtils {
  ...
  public static function configure(material:Dynamic, kernelRadius:Int, stdDev:Float, uvIncrement:Vector2) {
  ...
  static function gaussian(x:Float, stdDev:Float):Float {
