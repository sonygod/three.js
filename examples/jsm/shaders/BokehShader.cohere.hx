...
class BokehShader {
    public var name: String = "BokehShader";
    ...
    public function init(gl: WebGLRenderingContext): WebGLProgram {
        var vertexShader = compileShader(gl, this.vertexShader, WebGLRenderingContext.VERTEX_SHADER);
        var fragmentShader = compileShader(gl, this.fragmentShader, WebGLRenderingContext.FRAGMENT_SHADER);
    ...
    private function compileShader(gl: WebGLRenderingContext, shaderSource: String, shaderType: Int): WebGLShader {
