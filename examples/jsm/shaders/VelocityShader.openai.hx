...
import three.js.lib.UniformsLib;
...
class VelocityShader {
    public static var name(default, null) = 'VelocityShader';

    public static var uniforms(default, null) = UniformsUtils.merge([
        UniformsLib.common,
    ...
    public static var vertexShader(default, null) = '
#define NORMAL
...
';
    ...
    public static var fragmentShader(default, null) = '
#define NORMAL
