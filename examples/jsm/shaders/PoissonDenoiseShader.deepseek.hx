...
class PoissonDenoiseShader {
	...
	static var name:String = 'PoissonDenoiseShader';

	static var defines:Map<String, Any> = {
		'SAMPLES': 16,
	...
	static var uniforms:Map<String, Any> = {
		'tDiffuse': { value: null },
		'tNormal': { value: null },
		'tDepth': { value: null },
		'tNoise': { value: null },
	...
	static function generatePdSamplePointInitializer( samples:Int, rings:Int, radiusExponent:Float ):String {

		var poissonDisk = generateDenoiseSamples(
			samples,
			rings,
			radiusExponent,
		);
	...
	static function generateDenoiseSamples( numSamples:Int, numRings:Int, radiusExponent:Float ):Array<Vector3> {
