...
function generatePdSamplePointInitializer( samples:Int, rings:Int, radiusExponent:Float ) {
...
function generateDenoiseSamples( numSamples:Int, numRings:Int, radiusExponent:Float ) {
