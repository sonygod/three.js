...
class VelocityShader {
	...
	public static var name:String = 'VelocityShader';

	public static var uniforms = UniformsUtils.merge([
		UniformsLib.common,
	...
	public static var vertexShader = '#version 100
#define NORMAL
...
';
	...
	public static var fragmentShader = '#version 100
#define NORMAL
