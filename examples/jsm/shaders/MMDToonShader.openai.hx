...
class MMDToonShader {
    ...
    public static var fragmentShader:String = ShaderLib.phong.fragmentShader
        ...
        .replace('#include <envmap_fragment>', mmdToonMatcapFragment);

    public static var lightsMMDToonParsFragment:String = /* glsl */'
    ...
    public static var mmdToonMatcapFragment:String = /* glsl */'
        #ifdef USE_MATCAP
