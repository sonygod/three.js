...
class MMDToonShader {
    ...
    static var defines:Map<String, Bool> = {
        TOON: true,
        MATCAP: true,
        MATCAP_BLENDING_ADD: true,
    };

    static var uniforms:Map<String, Dynamic> = UniformsUtils.merge([
    ...
    static var lights_mmd_toon_pars_fragment:String = /* glsl */`
    ...
    static var mmd_toon_matcap_fragment:String = /* glsl */`
    #ifdef USE_MATCAP
