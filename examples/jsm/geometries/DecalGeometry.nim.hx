...
import three.js.examples.jsm.geometries.Float32BufferAttribute;
...
class DecalGeometry extends BufferGeometry {
	...
	public function new(mesh:Dynamic, position:Vector3, orientation:Vector3, size:Vector3) {
		...
		function generate() {
			...
			var decalVertices:Array<Dynamic> = [];
			...
			var normalAttribute:Dynamic = geometry.attributes.normal;
			...
			for (i in 0...decalVertices.length) {
				...
				var decalVertex:Dynamic = decalVertices[i];
		...
		function pushDecalVertex(decalVertices:Array<Dynamic>, vertex:Vector3, normal:Vector3) {
		...
		function clipGeometry(inVertices:Array<Dynamic>, plane:Vector3) {

			var outVertices:Array<Dynamic> = [];
			...
			for (i in 0...inVertices.length by 3) {
		...
		function clip(v0:Dynamic, v1:Dynamic, p:Vector3, s:Float) {
