...
class TeapotGeometry extends BufferGeometry {
	...
	public function new(size:Float = 50, segments:Float = 10, bottom:Bool = true, lid:Bool = true, body:Bool = true, fitLid:Bool = true, blinn:Bool = true) {
		super();
		...
		var notDegenerate = function(vtx1:Int, vtx2:Int, vtx3:Int) { // if any vertex matches, return false
		...
		for (var surf = minPatches; surf < maxPatches; surf++) {
			...
			if (lid || (surf < 20 || surf >= 28)) {
				...
				for (var sstep = 0; sstep <= segments; sstep++) {

					var s = sstep / segments;

					for (var tstep = 0; tstep <= segments; tstep++) {

						var t = tstep / segments;
				...
				for (var sstep = 0; sstep < segments; sstep++) {
					...
					for (var tstep = 0; tstep < segments; tstep++) {
						...
						var v1 = surfCount * vertPerRow * vertPerRow + sstep * vertPerRow + tstep;
						var v2 = v1 + 1;
						var v3 = v2 + vertPerRow;
						var v4 = v1 + vertPerRow;
