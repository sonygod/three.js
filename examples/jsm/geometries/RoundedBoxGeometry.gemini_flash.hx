import three.core.BoxGeometry;
import three.math.Vector3;

class RoundedBoxGeometry extends BoxGeometry {

	public var _tempNormal:Vector3;
	...
	public function getUv(faceDirVector:Vector3, normal:Vector3, uvAxis:String, projectionAxis:String, radius:Float, sideLength:Float):Float {
