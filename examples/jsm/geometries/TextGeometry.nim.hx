import three.js.examples.jsm.geometries.ExtrudeGeometry;
  ...
  public function new(text:String, parameters:Dynamic) {
    ...
    if (font == null) {
      ...
      if (parameters.depth == null && parameters.height != null) {
        ...
        trace.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"); // @deprecated, r163
...
export haxe.macro.Type.createInstance(TextGeometry, []);