...
import three.src.math.ColorManagement;
import three.utils.MathConstants.eps;
import three.utils.ConsoleWrapper.CONSOLE_LEVEL;
import three.src.constants.DisplayP3ColorSpace;
import three.src.constants.SRGBColorSpace;

class ColorTests {
    static function run() {
        var colorManagementEnabled = ColorManagement.enabled;
