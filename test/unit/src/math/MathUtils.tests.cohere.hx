...
class MathTests {
    static public function main() {
        ...
        QUnit.test('generateUUID', function(assert) {
            ...
            assert.ok(regex.match(a), 'Generated UUID matches the expected pattern');
        });
        ...
        QUnit.test('inverseLerp', function(assert) {
        ...
        QUnit.test('damp', function(assert) {
        ...
        QUnit.test('pingpong', function(assert) {
        ...
        QUnit.test('smootherstep', function(assert) {
        ...
        QUnit.todo('seededRandom', function(assert) {
        ...
        QUnit.test('floorPowerOfTwo', function(assert) {
            ...
            assertCoefficientOfTwo(MathUtils.floorPowerOfTwo(4), 4, 'Closest lower PoT to 4 is 4');
        });

        QUnit.todo('setQuaternionFromProperEuler', function(assert) {
            // setQuaternionFromProperEuler( q, a, b, c, order )
            assert.ok(false, "everything's gonna be alright");
        });

        QUnit.todo('denormalize', function(assert) {
            // denormalize( value, array )
            assert.ok(false, "everything's gonna be alright");
        });

        QUnit.todo('normalize', function(assert) {
