import js.QUnit;
import js.OrthographicCamera;
import js.Camera;

class _Main {
    static function main() {
        QUnit.module( "Cameras", function() {
            QUnit.module( "OrthographicCamera", function() {
                // INHERITANCE
                ...
                QUnit.todo("left", function(assert) {
                    assert.ok(false, "everything's gonna be alright");
                });

                QUnit.todo("right", function(assert) {
                    assert.ok(false, "everything's gonna be alright");
                });

                QUnit.todo("top", function(assert) {
                    assert.ok(false, "everything's gonna be alright");
                });

                QUnit.todo("bottom", function(assert) {
                    assert.ok(false, "everything's gonna be alright");
                });
                ...
                // PUBLIC
                QUnit.test("isOrthographicCamera", function(assert) {
                    var object = new OrthographicCamera();
                    assert.ok(
