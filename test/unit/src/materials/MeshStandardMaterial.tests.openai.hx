    ...
    QUnit.module("Materials", () -> {
      QUnit.module("MeshStandardMaterial", () -> {
        ...
        QUnit.test("Extending", (assert) -> {
          ...
          assert.isTrue(object instanceof Material, "MeshStandardMaterial extends from Material");
        });

        // INSTANCING
        QUnit.test("Instancing", (assert) -> {
          var object = new MeshStandardMaterial();
          assert.isTrue(object != null, "Can instantiate a MeshStandardMaterial.");
        });
        ...
        QUnit.test("type", (assert) -> {
          var object = new MeshStandardMaterial();
          assert.equal(object.type, "MeshStandardMaterial", "MeshStandardMaterial.type should be MeshStandardMaterial");
        });
        ...
        QUnit.test("isMeshStandardMaterial", (assert) -> {
          var object = new MeshStandardMaterial();
          assert.isTrue(object.isMeshStandardMaterial, "MeshStandardMaterial.isMeshStandardMaterial should be true");
        });
