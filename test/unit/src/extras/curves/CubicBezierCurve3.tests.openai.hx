...
import three.curve.CubicBezierCurve3;
            ...
            QUnit.module("Curves", () => {
                QUnit.module("CubicBezierCurve3", (hooks) => {
                    ...
                    QUnit.test("Extending", (assert) => {
                        var object:CubicBezierCurve3 = new CubicBezierCurve3();
                        assert.ok(object instanceof Curve, "CubicBezierCurve3 extends from Curve");
                    });
                    ...
                    QUnit.test("type", (assert) => {
                        var object:CubicBezierCurve3 = new CubicBezierCurve3();
                        assert.ok(object.type == "CubicBezierCurve3", "CubicBezierCurve3.type should be CubicBezierCurve3");
                    });
                    ...
                    QUnit.test("isCubicBezierCurve3", (assert) => {
                        var object:CubicBezierCurve3 = new CubicBezierCurve3();
                        assert.ok(object.isCubicBezierCurve3, "CubicBezierCurve3.isCubicBezierCurve3 should be true");
                    });
                    ...
                    QUnit.test("Simple curve", (assert) => {
                        ...
                        // symmetry
                        var curveRev:CubicBezierCurve3 = new CubicBezierCurve3(curve.v3, curve.v2, curve.v1, curve.v0);
                    ...
                    QUnit.test("getTangent/getTangentAt", (assert) => {
                        ...
                        expectedTangents.forEach((exp, i) => {
                        ...
                        expectedTangents = [
                            ...
                            new Vector3(0.9973375594129282, 0.05740742907719314, -0.044968652092444425),
                    ...
                    QUnit.test("computeFrenetFrames", (assert) => {
                        ...
                        var frames:Object = curve.computeFrenetFrames(2, false);

                        Object.keys(expected).forEach((group, i) => {
                            expected[group].forEach((vec, j) => {
