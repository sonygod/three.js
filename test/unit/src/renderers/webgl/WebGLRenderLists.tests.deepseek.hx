...
import js.Lib;
import three.js.test.unit.src.renderers.webgl.WebGLRenderLists;
import three.js.test.unit.src.scenes.Scene;

class WebGLRenderListsTest {
            ...
            QUnit.module('WebGL', () -> {
                ...
                QUnit.module('WebGLRenderList', () -> {
                    ...
                    QUnit.test('push', (assert) -> {
                        ...
                        assert.deepEqual(list.transparent[0], {
                            id: 'A',
                            object: objA,
                            geometry: geoA,
                            material: matA,
                        ...
                        assert.deepEqual(list.transparent[1], {
                            id: 'B',
                            object: objB,
                            geometry: geoB,
                            material: matB,
                        ...
                        assert.deepEqual(list.opaque[0], {
                            id: 'C',
                            object: objC,
                            geometry: geoC,
                            material: matC,
                        ...
                        assert.deepEqual(list.opaque[1], {
                            id: 'D',
                            object: objD,
                            geometry: geoD,
                            material: matD,
                    ...
                    QUnit.test('sort', (assert) -> {
                        ...
                        assert.deepEqual(list.opaque.map(item -> item.id), [2, 3, 4, 5], 'The opaque sort is applied to the opaque items list.');
                        assert.deepEqual(list.transparent.map(item -> item.id), [5, 4, 3, 2], 'The transparent sort is applied to the transparent items list.');
                    });
                });
            });
        });
