...
import three.renderers.webgl.WebGLRenderList;
...
class WebGLRenderListsTests {
  ...
  public function testRenderers() {
    test("WebGLRenderLists", function(assert: Assert) {
    ...
    test("WebGLRenderList", function(assert: Assert) {
      test("init", function(assert: Assert) {
      ...
      test("push", function(assert: Assert) {
        var list = new WebGLRenderList();
      ...
      test("unshift", function(assert: Assert) {
        var list = new WebGLRenderList();
        var objA = { id: 'A', renderOrder: 0 };
        var matA = { transparent: true };
        var geoA = {};
      ...
      test("sort", function(assert: Assert) {
        var list = new WebGLRenderList();
        ...
        list.sort((a: WebGLRenderListItem, b: WebGLRenderListItem) -> a.id - b.id, (a: WebGLRenderListItem, b: WebGLRenderListItem) -> b.id - a.id);
