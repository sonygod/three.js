...
class ConstantsTest {
    static function defaultValues():Void {
        var assert = QUnit.test("default values");
...
class ConstantsModuleTest {
    static function $init():Void {
        QUnit.module("Constants", {
            beforeEach:function() {
                trace("Constants module test setup.");
            },
            afterEach:function() {
                trace("Constants module test teardown.");
            }
        });
    }
}

ConstantsModuleTest.$init();
ConstantsTest.defaultValues();