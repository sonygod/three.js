...
class StandardMaterialEditor extends MaterialEditor {
	...
	public function new() {
		...
		metalness.onConnect(function() { this.update(); }, true);
		roughness.onConnect(function() { this.update(); }, true);
		emissive.onConnect(function() { this.update(); }, true);
		normal.onConnect(function() { this.update(); }, true);
