...
class OffscreenCanvasCubes {
    ...
    public function main(data:Dynamic):Void {
        var canvas = data.canvas;
        var renderer = new THREE.WebGLRenderer(new Dynamic({canvas: canvas}));
        ...
        function makeInstance(geometry:THREE.BoxGeometry, color:Int, x:Float):THREE.Mesh {
            var material = new THREE.MeshPhongMaterial(new Dynamic({color: color}));
    ...
    public function size(data:Dynamic):Void {
